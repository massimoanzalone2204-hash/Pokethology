...
export const getDailyHubCombatChallenges = (todayStr: string): HubCombatChallenge[] => {
  ...
  const bronzeSlot4Pool: Omit<HubCombatChallenge, 'id' | 'tier' | 'slot'>[] = [
    { type: 'stat', target: 'speed', title: 'Defeat High Speed Pokémon (110+ Speed)', required: 3 },
    { type: 'stat', target: 'attack', title: 'Defeat High Attack Pokémon (110+ Atk)', required: 3 },
    { type: 'stat', target: 'special-attack', title: 'Defeat High Sp. Atk Pokémon (110+ Sp.Atk)', required: 3 },
    { type: 'stat', target: 'defense', title: 'Defeat High Defense Pokémon (110+ Def)', required: 3 },
    { type: 'stat', target: 'special-defense', title: 'Defeat High Sp. Def Pokémon (110+ Sp.Def)', required: 3 },
    { type: 'stat', target: 'hp', title: 'Defeat High HP Pokémon (110+ HP)', required: 3 },
  ...
  const silverSlot3Pool: Omit<HubCombatChallenge, 'id' | 'tier' | 'slot'>[] = [
    ...
    { type: 'stat', target: 'defense', title: 'Defeat Huge Defense Pokémon (130+ Def)', required: 4 },
    { type: 'stat', target: 'attack', title: 'Defeat Huge Attack Pokémon (130+ Atk)', required: 4 }
  ];
  ...
  const silverSlot4Pool: Omit<HubCombatChallenge, 'id' | 'tier' | 'slot'>[] = [
    { type: 'stat', target: 'speed', title: 'Defeat Huge Speed Pokémon (125+ Speed)', required: 4 },
    { type: 'stat', target: 'attack', title: 'Defeat Huge Attack Pokémon (130+ Atk)', required: 4 },
    { type: 'stat', target: 'special-attack', title: 'Defeat Huge Special Attack Pokémon (130+ Sp.Atk)', required: 4 },
    { type: 'stat', target: 'defense', title: 'Defeat Huge Defense Pokémon (130+ Def)', required: 4 },
    { type: 'stat', target: 'special-defense', title: 'Defeat Huge Special Defense Pokémon (130+ Sp.Def)', required: 4 },
    { type: 'stat', target: 'hp', title: 'Defeat Huge HP Pokémon (130+ HP)', required: 4 },
    { type: 'stat', target: 'bst', title: 'Defeat Huge Base Stat Pokémon (520+ BST)', required: 4 },
    { type: 'category', target: 'mega', title: 'Defeat Mega Evolutions & Primal Forms', required: 3 },
    { type: 'category', target: 'gmax', title: 'Defeat Gigantamax & Dynamax Pokémon', required: 3 },
  ...
  const goldSlot3Pool: Omit<HubCombatChallenge, 'id' | 'tier' | 'slot'>[] = [
    ...
    { type: 'stat', target: 'defense', title: 'Crush Colossal Defense Pokémon (150+ Def)', required: 5 },
    { type: 'stat', target: 'special-defense', title: 'Penetrate Colossal Sp. Defense Pokémon (140+ Sp.Def)', required: 5 },
    { type: 'stat', target: 'speed', title: 'Outspeed Apex Speed Pokémon (135+ Speed)', required: 5 },
  ...
  const goldSlot4Pool: Omit<HubCombatChallenge, 'id' | 'tier' | 'slot'>[] = [
    ...
    { type: 'category', target: 'gmax', title: 'Defeat Gigantamax & Dynamax Pokémon', required: 4 },
    { type: 'stat', target: 'attack', title: 'Overpower Huge Attack Pokémon (140+ Attack)', required: 5 },
    { type: 'stat', target: 'defense', title: 'Break Through Huge Defense Pokémon (150+ Defense)', required: 5 },
    { type: 'stat', target: 'special-attack', title: 'Overcome Huge Special Attack Power (140+ Sp.Atk)', required: 5 },
    { type: 'stat', target: 'bst', title: 'Defeat Colossal Base Stat Pokémon (580+ BST)', required: 5 }
  ];

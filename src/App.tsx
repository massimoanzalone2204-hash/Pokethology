                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                      ...
                      <div className="bg-slate-950 p-3 rounded-xl border border-cyan-900/30 flex flex-col items-center justify-center gap-1 col-span-2 sm:col-span-1">
                        <span className="text-[8px] font-bold tracking-wider text-cyan-700 uppercase font-hud">Effect Chance</sxúÏ=Ìr€∏µˇ˚∞¶çÏ^Q_ñ«ïµ„8NÍÈÊ£∂g€ùL&KëêÑö$X¥¨z¸˝ŸgËs‹7πOrœø%Ç¢l'u∂·ÏlDŒ˜98Ä}”˝ÜhÆ°MèXé)ƒ;”•GIo§q„ê	˜§·rèıƒZòû1Ëv£[AjIjøÂ◊Ùï&s⁄t2ÅGü≠ôÈYî¸@~˘Ì⁄Vwø˚Öí¶a4ÔÜB„∞c≥ÎÚó⁄W⁄∑ùﬂìiJr@L© øÔ‹ï5+Å^¿g
v¸ÏŸ3≤¶I€°ﬁTŒ»àt±ıv˘ Ã<Ú5Fø°≈∆l∞B≠è˛Õßà`cÓÿD¶u≈º©1g6rÙ€ÔvIË˚4∞LA£f·R{!…òù1N~®o_tªù›.Ò«FØ1zÀm6a–˜©"©vf-ƒKsúÃ&¯?√‚é0zdj˙^Oå∂k˙€€¬j∂CéFTÁÄπ¢ã£[vój<5ÑcJjºÿÎvˆ`öFü<Ùlj«XXAFøK&Ω!ÖdìÖ1¶rN©Gò§Æ0,ÍITÃJAS*|â®EÑ˚ÿÎVR7•bJXQKa®ÌAØÌÄ˙∞’v”h∂Hì4w÷\9l∑ñWÖXºıF≈“h≠ÈfëX	—qˇ” ∞¨TËèËQ@mı†≤øùªÍ	#£-¯Àˇ¸6{vá˙*ª#ó«oN´Q∏Õ∫MÅºS¶ú÷|®}U⁄*ƒc€fíqœt»[Øt¢ãÕu⁄-áèW¶4†‹˙ërã%˘E=πàZGÍHY‹ç4#í§?\P@3ïo¢TŸ::"Mè{¥©ßf˘ÑKU‡2ä£πtØW<£„≥ﬂûæª<ºè™*(Ö¢^¨Åå⁄qùÿÍ§∂úb~¿x¿‰BQMŒÑy`vû!>úüΩ??ª¸˘î®ˆìÈuºK3òR˘L@8∑J7'≈ﬂËÚ¯¸ÕÈCX?æøû˘#‹ÀC∏/-Õr-∆ó∆†ËëU˙`√q(%˜àLÓù8Ã∫:∫›V>•†ÚLdà{ÔSo{b:ÇjÁôáÏ∆8 >ÿ=nfj™f–[pò<ŸK¸Ω˘»úı™„ReVoŸÿ≈>¨1	_zBY6√Ñ[13m>7>v?w?˜ˆ¸õœ¡tlnÔZ˝^Ø’ﬂ=hu€ÉùOÂNïé'(é¡t.*Gòﬂ n+}<Ï∏Á“^yß{ì£’∞sÏ1§‰C@Öp4k7º%($0˛L ù!T…#ºøSº”,FæE¬§ìı™O*%–Fü†˚ºõ5‘Çü2ë|âΩØ*¨a6›%1»m:G∑∑ÑÉÛZˆ€ªeû5£¡Õz´ÕËìÎ∫*ç	ªS∆<¿ë—%ˇ NÓw?ERöèìñD¬Ø  ¥“UÁ†€Ä–N¸»¶3	ò£àÄÜúQó>k,…‡
£h—S@ê∞Lá¬ú⁄/ZÊ÷/ô\Sq˚ûj]⁄8¡W≠ûKÉQP
±EÈ‹U–•&“›øq»<íq◊º1ÊÜp	jóâÚ=c∂\ìóˆΩn©¥˜w>)Ã˜–7ˆ#*·ˇ–óUéÏ`YîàjsY Ω;÷ò≈·¨ØML•™1ñı:pï€™2√TJscœç=23ˆyâŒ_…7•*m÷/ù]l M^‹SeRÍUeÜd)uê©z Ñn∂-Ns¶πØô¶^qÎ‘v/j∑ú—8• /°ÎVcáth¸CU˚3o¬U[Ñ∫¶%íã◊Ú,Kï[¬˛±v+$úRo`YÚW¬‘¨±^!‹¨˚)ºÚÀlπÜ/ H∑"CªÀπaùœáò›DûJ€GÚà£ãÖÄy© À≠ÚSÀsÊ¢4gé™êo,ÀÈnï÷“‚Ú'FÁÄuì©Ù∏˛C≤VóæÀ€#À€KŒØîØ¯Ddôñ$$ˇ•ë˘•.ıâ∑∑r≤^Úê]E[.|òÚˆwâ{<âªÕ„ü¸ ^d®>rHÜo9◊Ω÷ÊMæòpæb¬wÃF•Ù[îÕe‹7’MWó_ô¡U≥£ﬂñπ|
f≠≥ïﬂ<=≤IUx*ˆÙ%‹O¶àÇÎõ€±)•C/1ëÛ’Etfz∂C£P‡†4YÉÕÑ9v®çY¿s:Ê≈ˆÒ©P|vs‚£ûE¬Pîü‹ãÇ¯‡Ûz“C\iÙ”9∆â<¯8{fÖÅ‡Å·qâüÒ9µøê»%ãˆZÈ9ÁÙ»â5_N*&íáY¡î&*+ßÁ˙ØQL¿.u˛≈DSøï¨Tz”n∑ï±ä˘êD\©1[’Uè ÎHñRQ«˜ìtòïè&·_u1 ”ˆ/ïû"§éøyÊ>˙ø˝ñr˜%y˚›{‰Ì…˛µÓ√ì00Ñ[T%øÓD}âV^…”;”öy˙˛Óã÷˛˛ß“ÙõÁ·eñV©{≤[£í≠‡ÌïKzYæ~åzB∏áÂ…˚ïçï‹}‰dƒÎ∏‰s"y,è∫ºzebΩ(ç⁄‘z4—Ωbn=ZòUÀYÛ»uFŒêÁV_RæXf≥FÜôüwØgüàî‚Æ!¨Ä;ŒÿHRZ5(O®k
± ”ÔH…]}UbfsdÀMMΩï≥∫ÑE|±	`¢c/,,Ó“Ój Û5¥JÀ%¡†9‘¥q¸Ä:&h±∆Ëg‰ø¢`Â¿e Œ ∆tËDÇû∞’ı®ª»Ω0Ülì?QÍCB4y3£¶#g†⁄±EŒ&ƒLªûR)‡+/C É]¡º¬ 8GgÇ{‡∞H2gjÌx¸1`FûÜéY@TπÊ∞„oT“¸ÖËm∫c ’„<Í+£¯_f¶$†u¡CbÛ*:5(û“Ö4∞êMÔV:lÙˇ˙'¯C2‡ﬁtÙ	–cπMÙÑ| µttAë6¿ö0¡6ym
TÑ	µCÇÉº SN&,rkÿÅÆkéötr0*rC_ö>ÚY∆S.∑©ÉP €¿>ÇX¡¢Ω…P«g u5ñ£4#i¬´†û§”Eì∞â"«‹Ù@*Ïkf)é≠gÕ"TÄpåïNÊ0wZ√∞:±c´æCâa„Œ2é=ôô\ƒ≤˚+ßèΩéø¢†.gÄ[Ü∫cz‚6õªäÚ[ÂÂI√q–ÁÀ7}†¶ rŒìocÓiW}Z‡U|p}ÖıM¢âÙ≈∫∏AÃ¯¢≤ó≤†^w8ı©†¯ÜÉ¶Ûƒ÷fÍl;ôwHä˛ılçáÚ◊ CO\^™.Nq‘®Eö‡«4wZDzAÿ9z√%àÍ÷äa‘Ï∆¡K≤ ˛á-˜)7˙Ø[j’’é[VÍãä5 ±S˚ù⁄˚≈4±∑\Z‘øÌ“)‰©Â¡ÀÊ±Kç¬#D^‡0èõZÏ¨*«âì‡Ÿ[ÉO&»∞ç
\‡™Ü‰DÒfyò£Qìâ/“"ø˝`7±\¬] Í¨xyLR; p£=cJ¥kˇ˚o9„ü.*Ò IçmúhÕÖ¬Nˆ3J¶ñfûW±ì´hıô4¡≤êíπÄáª5˛2£pE@MW(ì	ê;5>÷Xª°1ú´cñ∏hçôáﬁÑ•xâO
®C_[<=Ù:f‡É'Àê·‡!ª£æ-Ã‹ Wb#ka9‹ß63¥w«‡¡ÊÜ¿<hì3àkLÙM)pàM&∏ËƒãÈ‡xòOF)¶‘|éÚ£‚0… 5Wæ6¿}ÂÒπAÔb%dh/‚x	#-—ä}”u®–õ*áƒç„* »"Cß» ,`:‚∆®g∂…)»√ÇL ~†6«OMﬂ'ΩÊ8F–PÕe Æ1É´Bà!¶s]ƒåÑÊñ ‡∏	ºƒ6•Ÿ"~@}3H>}Åª&Têv|¿ `ô£°ã ´ËM=Î>Ò•ær¡|ãåˆ:Bõ®»©8Õf¬Bˇz/U>˙-)’\@ªòÊƒ±XÑÊÒBœjüΩZ©r…AVS3,5Öür·”ò© ‘JñT◊uy1nçRä≠¿ñ p‚ñgQ84 gX◊-Dh«B ≤0*SQ†„+2±ƒ˛4Õ•∏-ëYUÄ>8,S;,buôFMëMx9•iƒ$J/¶÷tºß~˝Ä≤Ÿkw€› èhèüÉ>µë0Ú9˛pVµ∞ıè™äÖ®U[L 6ò¥˜eã	˙¡56ïÄ®›R2 ∞ü∫Å≠ﬁ`Ø’{Ô)!ëë9Té+†±˛
cY=Ì£®T`„h+≠Ò¯nÂ«˚nÆ˝Ì_hÎ∆˛ó‹∫—•˛q£^ﬂgCEV>uü›OaÔÑ&(À¢∂ÏXÖ“Ò˝—…å„ﬁ<ÂnNÃk‹sã˛ÉhÙTähïP)∂—È@gÌ8«l∞£∫¿p‚!kW,6åoˇÇKˆ#sô<ß¶5´ﬁ]‰%≈4É≤¬ôΩxáø±õ/íY›í“KD¨[¸+˘º◊Eé$Z√¿À¥’ø¬aÍáÅëè!AóUÌÆÆW'SΩYxxÏ–@^ÃÙ¶@ì'Ó'Ê™l–'0˚!EÕöÍ∫¥T§Œ9…ÇnŸ°$‡ ˛	LNof&hjØ€dºfãqIæ=Ç±PÆíï∑∏i¨Àx¿8X =K ^q'FŒ4ÅøÂ–W¶mGÇÖ±Íp<zs˙ˆÏ›ŸgpD?ˇÈÙg˛QQ¬À§ˆS=v©ímdµ‚°ıî0ã{;‰ŸT˛!jQµåZÉé>Ã9ÅÀAi—dË#jìd›hºVïÈüóÖtÕ>hºrdr%Hÿ2≠ä¡eŸ°™ôZ∞UTÃ2kÉi«Ø"Ò+&\Ë|FŒ©x‘FÔµ¨™¡Ãz∞dzı°q’6ª*-§?¨a∑TÜÎ’∆≠ÿ„PrË"`q±VÏ+‘œRyFŒËùáJ©o='ò‘ƒL™•iÁ3ÙôT˛ @ª˜Åc’°^´É”?fßû*Ø‹ﬁ2Û∑RS˚‰%å˛˝ı“´âtK—]ÂyMÖi·YM˘84ã:’ôM©C¸<ıd“√n¥ChQUQqπ‘˚w
Ä˜Ø_7ÙÂïUí^U`˘x˝µS˘@›5"π9œG(œ˙ﬂﬁ¢KO~=úø<≥ß¬¸%p5cQàˆ∆ƒﬂÖ∆è)	E'˚+Û~ctÒ˙Ø‰'ÓÑnÂ'üy∏~†E+fáè◊–∑rôw‘ËV50oéΩä‡_˙–Eª™çM'fË»üL'§ÿvØ¢-»®:∑ÑîFRÂµAX5f∂}3Ùµ√MπMì≥ÅÆ±w˝At§y®§≈,:È&cÛ\¬‚E∞¬x ®*”"Òvü´≈'µÇ‚…4+¢ìM¯ÚçÒ‰À7oı<π{?û‘¸˜Òd∂8’EÏwWVÈ}L.WˇÍ∑X}‘b®˘O˚kÈâ”åKr’˛,“´ﬂ¥_›îC¥•6ıFµyzﬁb}≥sì’iväÁûÃä[j~äŒëUB∫ÊŸuâéòU]’ãã◊ûÆöq'Œœ AµKk2˜UO’ß≥Ê6Ôë£££Ë„™L^KûQ>>(.N’<õl›ÄyÎ†ª≤EıyƒíOñ(˜™#e+S57G*ºü1Íˆ¯FõêÌàxúuDÉ¶z lÓ¨0›)åøA◊÷ÚéPòÁÙ¨0p…\ Cπ]ax!
(0X(,≤ÿâŒ3Õa#1,í˚”ZpÓZàﬂ]áêä∑öM÷xU¶^7]É©u†d¨âÍ(y[.ÿœû≈?fﬂ’9)V;ùjg+˜q∂–ó_®õQÃ"íèÉÈı[d	êùSzÿ&†`—°Õô7¡%¡EãÿaTáÎv¯A¡EË•ÀÊ}<W∫2;^∏ ¨E6án)à˛Ó8˜â Ë˛É <–5©~º*’Ì∫•Ç5È[ù/πi¡UÕ≈<W&«Î=vÂ» BgÈó≈“ë˝ßw6i˝ÇuÁ√\ød9à˙{iÜº‘‚q+µ+C∞D-˚ºÍ®ÓÀDZY)√AÕíëÙìZ≈#’<¬v„(B3(œähﬂWaê2±‘ÎN´©E-≤=÷hËY;v_±QÏ_J¸È"a#és!õ±£˝•‹°˚"ıS”ø~@r°ˇ1Ñ‹·Ÿ…öl∫*⁄[ukÀ˛6¬mxM≈‘/ÒvKe’˝èQﬁ÷JJ±DÊ"WÖÓÜùãPÄ∆ÒÎaÁ4xig|~‹›o˛  ˇˇ ãPÆ#
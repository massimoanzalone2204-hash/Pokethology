                                  ...
                                  >
                                    ...
                                    <div className="w-full flex-1 grid grid-cols-1 lg:grid-cols-12 gap-0 lg:gap-6 items-start max-w-full pb-2 sm:pb-3">
                                      ...
                                      >
                                        ...
                                        <div className="absolute top-[12%] right-2 xs:top-[15%] xs:right-4 sm:top-[20%] sm:right-12 md:top-[25%] md:right-16 lg:top-[14%] lg:right-24 xl:top-[12%] xl:right-28 pointer-events-auto z-10">
                                          {battleOpponent && (
                                            <motion.div
                                        ...
                                        <div className="absolute bottom-20 left-2 xs:bottom-24 xs:left-4 sm:bottom-28 sm:left-12 md:bottom-32 md:left-16 lg:bottom-24 lg:left-24 xl:bottom-20 xl:left-28 pointer-events-auto z-10">
                                          <motion.div
              ...
              >
                <div className={cn(
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <TypeBadge type={selectedMoveDetail.type} size="sm" />
                      <span className="px-2 py-0.5 bg-black/40 rounded text-[10px] font-bold tracking-wider font-black text-white uppercase border border-black/50 shadow-inner">
                        {selectedMoveDetail.currentPP ?? selectedMoveDetail.pp} / {selectedMoveDetail.pp} PP
                      </span>
                      <span className={cn(
                        "px-2 py-0.5 rounded text-[10px] font-bold tracking-wider font-black uppercase shadow-sm border",
                        selectedMoveDetail.damage_class === 'physical' ? "bg-red-600 border-red-800" : 
                        selectedMoveDetail.damage_class === 'special' ? "bg-indigo-600 border-indigo-800" : "bg-slate-500 border-slate-700"
                      )}>
                        {selectedMoveDetail.damage_class}
                      </span>
                    </div>
                  </div>
                  <button 
                    onClick={() => setIsMoveDetailOpen(false)}
                    className="relative z-20 p-2 text-white bg-black/40 hover:bg-black/60 border border-white/25 rounded-full transition-all shrink-0 hover:scale-110 active:scale-95 shadow-md flex items-center justify-center"
                ...
                <div className="p-4 sm:p-6 space-y-6 bg-slate-900">
                  ...
                  {selectedMoveDetail.description && (
                    <div className="space-y-2">
                      <h4 className="text-[8px] font-bold tracking-wider text-cyan-600 uppercase font-hud tracking-widest border-b border-cyan-900/30 pb-1">Data Entry</h4>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                      <div className="bg-slate-950 p-3 rounded-xl border border-cyan-900/30 flex flex-col items-center justify-center gap-1">
                        ...
                        <span className="text-xl font-mono text-cyan-400">{selectedMoveDetail.power || '--'}</span>
                      </div>
                      <div className="bg-slate-950 p-3 rounded-xl border border-cyan-900/30 flex flex-col items-center justify-center gap-1">
                  ...
                  {selectedMoveDetail.stat_changes && selectedMoveDetail.stat_changes.length > 0 && (
                    <div className="space-y-2">
                      <h4 className="text-[8px] font-bold tracking-wider text-cyan-600 uppercase font-hud tracking-widest border-b border-cyan-900/30 pb-1">Modifier xúÏ}€v€Hí‡˚|E∑∫DıäIâ*Y-…CQ¥≈-›Z§´⁄Î„cÉdäDÿ hä•÷ÃÀŒÀû≥ÁÏÀ>ÔÏ˚¸…¸¿Ó'lD&.	 3R≤À56g⁄%âºFD∆=:∑∑tË{á€ì›„"“œ·»¸HÜñ·yó∆îï∆Æ9"¯OeËX^•N∆∆¨“(©^'‰ﬁ£BGŒGzJ}√¥™ûo¯ÔÜ√SØ:5fÂ≤7‹"Ê&9:&eeO¡d>–Â—˝{oX˘˛ﬁ≤ÆûWmò˘«?à˘ øöÔƒ)∆œ2|Zy÷¨m7kÊK\gnèËàwD›‡?ï·“∞+œjµÌFç‹ZÙé¸:˜|ÛvYPA©MLüNΩ ê⁄>u5kfsıfÜ-N√ßw>a∑V#Ï€õzmv˜ñ‹:∂_8÷à¯Æ1¸`⁄„ ¬ƒi±ì˘àÃg3Íèñé√E≥5W]:≥å!-oT6∂»Ÿÿ|8‹∆ÅWõ€˝–÷m;~J≈'<ulß¥ï”¨Ç 9&5Ú<ËÏ¬.„˛î»AìKGÏmõ˙#¶|ˇüøè{x„≈ﬂHØﬂzŸ—oaÓ6n¥™ln>®PN˝¢Út&˘ı~˚œ§5ôæÈÿÜE. ˚»ü∑e„ ∞täÕ¯AÅëi¬ €1§ï•ÜNv3¯f_O1ŒÏŒDX#F¢ΩÁáà<»`Ù‡˝†R/˚qj¯∆#h_É”æ ïüCﬁö”#Î’'I˛ò¬£…i¬È‚wGGd√vl∫°>M˘Ç•40Ω≈|-˚µpÉÛ)œq´{~—πÏ¨C´T!IlFÚòá∑*¥ïüÿÃ5◊ÙóÏŒπ5m∏wæêÉ∏æÈ^›t˚Øq·ç&?Äp˘ü}ﬂ}√Sˇ3Ï3ZP¡µiπ†hˇé˚≠õóù«Ä>æë¸|÷b÷=ãßª∫“'3Û+ªIûLÀÖÊæÔÿD1O«n[Ê√—}ôÒúıª^ºsW3jóoÀ£ Öä3ª´Ïì\|ÕËÆö@oÓA¯K~âÔ¨"úT|◊•Ø∏Äu≠‹Œ-⁄ªœ*|ı&∆»YTﬁ‘ﬁ’ﬁ’õ≥ªwÓx`îwv∑ı˙Vcg´V››|+Á•T«›∂òE.Ã•gzä≥Â€-ÎBqÓ“ü∑ßÆ•öy¶z"–·vÀ6ßÄ◊.ı®=§«1\˛B≠°3•ŒÓ}·}”√√>∫7Ω†~}[ ®¿$@Eh¬IÚ|“ü˚@˙+Òf¯#{’wÁâ7∑„ïÜÖäÔ>HÁïË=úÿ∂∏◊Œ
lH€ôŒ◊Ùª@50\Èñƒ≠ÿê9õíl-¡üôi√’Ã‡Ëûçﬂ
†7„&GÏ1
waòv‘Ey∆ÜøOÄ
L&h èˇí~§òg≤ùyK ¢ô˜ºÍ{ìoÏKyÛ/(ÍÚÃò˘Ê∞ºaô„âøëË··!±üÁÿ@è‚¶F_ƒsè˛Fñ˝h–íúÕ‰‡∏7D°àp–π˜√º«É¬@¨ËWôΩc|J!! ◊•æ‘j L+åõ¶¶4A˚û8¿˜√ B’CöZ|Çâfıl3zg˙y]≈Ñ[˙À—ˆ¬ó∂»»ò8çH£πEz∏µ©Á·WIW‚}oﬁ3f⁄ ï!øUﬁ¿Ω˙ñﬂ3¯2˙$°?x∂O@èGÆ3´¨π[i‹Yi˝≠ÑwbéF‘NÓVö»1°l:0ëÖ	/yë,}˚œ±Ê>\0lçXÙ÷Ø‘∑w…¢ÚlèL·¶ŸÆ◊íóõÁÃsÊòxgVËG‹´†LP©NŒ‡à¸∆wÜ≥ÄqËzêlQﬂôëﬁ“ÛÈîúQØƒ√-∞Uﬁ`‚LR*
6π()|å‹pﬁÙ ºÀw8àÍû[à¬ﬂÄL£^ª÷X¬çHYÃD«¨#)ì~w≥õ¿ˇ`¶ã
l2¸wR6˚ŒJ¿A£&”oØéZ0ıÉØr^bo´æﬂ v¢¨ƒŒÊ[n∑äÎ¢Lñ…EÏ¬"v˘"ö|Mí‘é›öNÅaô8è=)K≥,MåŸ*¶≥ÿ©48∞ùÖkÃ»b∏öÉˇ¢ZÛ§ëË:‰˚8Øº¯æ⁄rw∞|ˆé.ﬁÇùÑ≤#Õ ZÄ¯±ß§9©˚59{u¢`·&≈r“R Ië§Vm¶–<Ä=F'•∞áPπ[K≠T‰á£ÌïIÃ$gVB©7UÆ˚ﬁál)g‰’íêûmÕ˛Œ`IG)Q„^:∆òà∂î-	?æª$˜EXÚ@ÜÜ?úêÚªMr/€ÇÃÂàÒ¨·®9]‹©2\eÇNíﬁDÚ0z$˜_œó›â$#ˆ#;ŒúÔ%eõ·‹ı∑\!˙Ö[Ø§$†Ò~HÔ¬í`ä…öd{|”∑`k∏\TÓx√Õl+)H˝MFŸ»æ)Æ„ÛKI\;˚Û÷qßd4wˆS‰rÇóFVŒë‡…ô∂e¬u{‹>øÍuTÄØí‰§Ëês3⁄Yèô£e≈ ˘Œ—C.ÿZ«≤@Ù ∂œ7ßÊo4¯	ÖÃ"p´ÏëÈ˛≥O¶∆].ÄπÈÔi¡…NÇ[ì›¿(¯«r∆K`˛ÜazÏ„/ÊuD≤#Fí—Û›£Äx»⁄p˘»¢>!_Ù˝&}g ]ªŒòvË`nÁ+˚UÜóAª˙˜πÈ¢Ë$æù¯Uˆ6cÈaM‘ b$|…∂ÕrÑŸ”§@ã9/®·œaﬁ§ÌxSsHz@œº«>ÿM(˘∞≈Ü‚%JB2R<tl∏[ç°o~§A[¥ê#RfÔø§6ä#T¶ﬂ“©aqu:{ˆÇ}ﬁ⁄$œ%øíÉƒ4˛"{2É¡2`∆>êCoM{T.ÉLcÿK.t«f@>´…lcÛyπäw¯ÈfM6ê·˚»Ñ<j0ﬁG¡GÙñÇåı∏ÉN
ÈÕZ˛#óËÕËÑ‹ JKıfßÙˆi∆]u¡êË±”ët8¥R¶»@¸»…ímRØmV}ÁäŸÂ˙¶ÍY”Òπ0¸I.«-ÁÙJ˛Lv™ç˝⁄˛Æ¶◊Æ=úP/Ïóq-Â‚ìä09¸Ωﬁêéµ`ç~À∑bQ|+x”ÛŒX6ÕEröçj£∂ª◊»Î’òp‘r/Öè®¡sÓãaƒ Rü.c#˙kcc3≤.lW∂«‹º∞Y˝X¥26Y´K4=JahÊàªgŒTJûWÕ9>Ç’¬áçúmÅSÅvˆ–öÉlTﬁò“±¡á-–Òb>6]sCæqÆøp‹Ø\œ√Ùz”^qœûÃÛ*j¢|‹A«üP˜yıÕÜs{krÚ¡ªŸx(Ë'˙Œc˝»ßòÓg‚‡îÖ˜6·"±·r‹L]—–]YÿŒb≥{jcÃ-ø‡ºtÎz¬ô>QOŸµ>M«imı3YØ£ºwﬂO|Êloª∆¢:6˝…|0˜@pÅ∑–ê=t¶€ÿqÎ∫ªÙπ=5<êÅ¢ØÅ}õMy;Ω€ﬂﬂ«‡º¡‡j{ékc„·˚{)>Tgˆ¯ΩâÅÖÓ&]√¸P•	®Ú—∞HßÍ2*¬®Ôh`ÚVÇCK$g{åû¡”ÕÕ‘.Ê–Œÿp’⁄ÎÑ˛ecπª∞
ª∞ªò˚IŸü]ï-ìkã®≥◊ThAO°—~ÑN€q—#ÏI¥⁄Ω6
ø¿n2Å±õ 6–á…∞m*SuØ†Ïé∑ÓÛjªßÔ^W„Ø6£ÚÊèßÛnÏ6∑ÍÕ˝≠zΩò“ñ—õÓxœbäÔhñ!µ©ÃÊñ'e÷ø∆œ¢òf[„•˜Ì5_GqıµŒ˝mÉ+¨{Ì÷ÂÜ⁄ﬂD©µVj˛‹üë¥WPŸÜ™ÜPg[L3+’}”ΩÊË^ãi_UŒ,üC˚x¨ŒüFΩx≥Ùò˙‘Xî¥9ßHNú—í}1Ã¢W £¥∂ªRùÌèùm°õ#j`ç“ﬁ∑{z>∞∂
jÇ{slÑ5ü⁄ ÷ü°.ÿ5f‘7¢∂e
«o”Ë)ÌöC9+#õj†âéØ„ƒç€Ò´!ΩûCåFˆKÿ¬$Áñ¡∂]‡ça`’C‘âLà˙Ñ√≥Wßm«ÖÖzR&%ﬁ¥Œ›hûÈì.cH⁄Ü;
mÒ™çQnM>á°faMÙ¥lêÈÄŸso_ïÁ§¬∆(ª›‚YÈóß$ÇZ7–√Œí&∑â˚Ñ˝õ9Z'È]w⁄›ãŒ%ª/;7Í•Á8wj∑&Â¶3O˚µòík◊˜üÓ{> 2ır›ëT6	s≥:3F=D„ÚŒŸ®mh~ıkTﬂ¯	y÷	9s*)∫˝æ3#œˆiªK“C¥‹\“ÛA<¿ÓZÄº¥éˇëÿûØÓÃú–îàÒPıàYc)K∞œA È¿Fu±ÁπCÎ]t√èåÒ:ç2Âfä)ÃuÂåñåâä\¢Ÿ À––$oƒd¯îπàãûìRZTI!ºLr·wDEédxπíaì!u—:œyR{˘
≠ûËX€}∞°êÌ©µx≤ÏáÏ¡FÌ>œπæË<……ÊÖ¿JÇªJÍ–œ?YÌbuË2”ÆﬂÀÿJwõ¯õg—3‹LT¥ÙXÙÄ‘´µf∞∞˚∆Lx≠V}ñ˚⁄ì*ˆCWG%æb}d:¨Å#"\hí"[í€8q$≤,ˆ46§T∆¿Ëo®#˘'!⁄÷CˇéF‚ÓÆ&’Eäπ
∑2©∞˘ö%√2‹≠IP?≈iÉ˚ h’ÚpJpéÑ©≈≈!&{Í5áÿ∆zºsAˆÄº©mëJ˛¡ˇ’ﬁ¢ﬁ!	®°Hã@é0ûGNF)ä6TLlBÅïrÎ%Ìƒπ(eÈhTedH˙s}ﬁzM⁄7Øµ§,AE÷ès“∞ògp3U^ x†Òî¥∏›ÖÙ&ŒÇqJ≈π H [¿¢æ¢(˜‚^æZ‡˝çkå–4∆ˇ¬ØÂ°È-˙ÒY£≠èÜ[ÆT¸E‘ÑjgÊmn‰ª ˙⁄¯&˘h¶˙é%©#W
æª5.ÏÜë2<ê)^Œ°>ñô5ﬁ°VvGÆïm47ﬂÍ‰Aï˙?¥ó¿EÀÜ’¯í%„œà93√E’äDÈü\z1M.~‘”6ßc#Âπ√£˚ÿL≠P)Úèa˘Gí€ó≈Íﬁvçksÿ‚œ	ˇ”¸JáÄ \}¢t›n»Æ	¢™ˆY|ﬂHŸÊÍr1qgW6tÿ‘ëUf)w©{Ì¿Öπ<*ŸN%¸I˝öÚÛ…A(¡·FÇ|âW∫ZªîÖWAØ
ë	)nëi'°VJq:4ôÏdFÖæBÖ	*®r4&’øã˙õz>± K("e"…0b_ù
a≤Sú^ƒ∫8ÊtﬁÓ©ôO˝\ıèdÍ∏Áçœ<o∂àô0üÎSsˆ·˝c4¶AfîÔÔ}÷'GÌ0
c"Oàe®˝f9Ä7ÊotÙ.tÔI4ˆ‡—Q…õÊ‹‘:P+A‰£Ídô/‡œıdÈô0_2µLW\ü‰ô‡DCmeî«§8åd’*!@BçíÖî∂l@πÊéÒ¶
6π1h ™÷ÕÃl†Uªt|÷Èæ<ÎóŒ'‘™
§!‚ÚéÔØ¡2%€‰>vØ{ÿ∏]ˆJπjLΩ8˙ˆp~yÍ√ôÕ›ôEÉ„	]»á1P‰ë‘b‡=ÍL
‹ë.0L.0À°?‚ÍVÜÏ1π≈C.Ü˙yáks÷=i·úJò¶„¢uÛö¥N∫Á›~∑”[O…ù>ìaó6@ÅË1öì,"?·É“$w√úY#õ‹	Ó:í°˛˝‹q’2í˙rFC∑ç≈|»∞ö6ÆjÊáôËpb≥kÖœ„£ÈÕ1ﬂ¡èæ‚;≥Ã;≈·2œò∞ﬂKÅMí]ﬂé“ˆáéT$Ê”u0ú4*õ3*Tõ˚]¬r ⁄ÔRV=Y-:|û±·ƒp€ïd ªõæS-ñ≠gV,ü¥zL@÷Ôë÷eÎ¸uø€Œ≈˜¸˚PK}ˇt¯á}Ú»K=7U°=ìAd.4JìkÌ®E∆≠≈L\4|lIîÄ9ù59&Æë&2g¸03–Yßuﬁ?#◊W›K8˚ÚŸıfë$AyyôDªÌ˝dV,?†òdõÏ˘$¡WeÓdùq1ÌyöªÏ‘&—p¢&«Âöú(¸Dß‘5,û?LóL'“-` Bâx˛“b^¿Ä±˛‰ÄÄ†ït}.Ofõzè*÷\mfŒ˛Ê6»A$å}˙ä1È˙ÏuØ€nùìVøﬂjˇÙ4ä)∂àG<$Ï+≈•HíAd
¸£üó¯?1>Â`FÓ}√ösr⁄y—π‘˘'fﬁÕ†Kì∆ö †Ò+Eõ0;bMt9?)Œ˚˚yë¶7˚⁄oÊö˜$óM‰0"bãd˛Jq&tïAú	UOé5l?;Œ|ÂwMà3Op’pëDÿ‚Øm¯ñàÉ˙´±Û)v¯s#&9¯äÒÊßÓeßﬂm£;xÁÙ1X#
¡I¥Å˛J—&‹ì o|jXük`É?ìû‡ëô÷–QÃ…c°:ﬁ¿¿ø—oZp≠|}pæ˛\PÎ`¢kﬂ:“∏”–’J‚¢Õäõ0Ûã6„3Ë&ÿ'rXAÍÊªé=ñ´?w"w=…îS…xr
Üºêhs^:æv>¸€ˇ¡πwlﬂ]ÖdkÁ6ì¬~Ω©x`>˜02¡É˘Ÿ|=Lá≈ÕYtdŒßdÄIª*ÿ'OÃá8siÖ∆4($ñø∏∆ÏÄlˆr1°.›»ıÚîx©¿Ó]sÜ§N{˘nœ>!9b;ß‘˚@∏ÁÊ*‚ƒçMÌë$&=≤˙Z§Öí>Üüâaè¢ˆû¬U[ë2¸®#í5Øi}œìAÄ9'lÂm¸ô˜Ω`Ö§ccsãîDÁôÈõ›Uˆ0ﬁbó|‚Å	ãπà…® ›öGß=Kc¢£≠X≈*ôÁN¢˚(:–F÷w1íÔ^ ‹$C‚Õrõxs
LKé•≤‡%áVR◊0Ì∂ÈÁ¶‘R]!)ÔÅË(päy≥IÛ£…óèÓv~!/^ùü«1è≠õˆY˜Á\)1/åeùÍOSæ ô~≥ºBñƒ˛Ñ¢◊sKË‹”«ßF¸Î‹¸ÌI·ˇØÀ
ˇ-+|—:ÇTıdâ·øeÑˇ„fÑœΩc4y·ãƒT|À˘˙gù´õ◊§Û∑÷Ö‚⁄˚ñı=˘dù¨Ô2I@ì/(ºü _–∑lAﬂ2µgòP¨~ñ‹ÏªèÀÕéx§dˇ»3SAﬁ‚ƒb»ı01ßÑΩÊ¯Ûc¬Ö~¬ Y÷ïæAbÂ[‡åΩ	%ÚòÑÆ¬w¯∑D—¨®\V∂&Áj6ÉK¡é˙øg[û;„∞¸)>«$õó,‚ËË>˛[2è≥Îh&g◊â˙\¡®ÿ ˛[“√Öq't¬æ…˙	ö%æJz√Mû{Qw¸´¨ø∞aÚ˚ju∫¢¸ó xCh¯‰sà∏$Îñ›–)÷‡êÎÇ“AåÎßoÄ	5>.”	äŸe¬F∆T;2-¥8â¡∞ºﬂÁ3I7}sJùπ/MâOà;∑y/Â‘õ[,]´≤ËôcwmÃcÓ+ñÛÁœa˛!¿Úzxô∂ò.¨o #√7$k(¥–ú˝J|ŸﬁF t®ÂR€ V“^áhPa9;UÑÂ4g[^ã@\fYûïΩiΩÄ’ÅÏ® $Ï+Ø›5Ä#uqD¯ﬂòzÂ˚†Ñ »‰[arˆw:g~Ú«0°=˚ïŸ¡ÿ_Ù£·Òòjòc»•}˝ÍÔπúÑÑ¥¸Ê≠òQ:
]q‰xÑ◊öﬂ3ßsã±eUW€ŸãÔ~È∑Ê#”¡ÙÊ	Ec"¬»Ùp∆§ƒeÚ§È‡˛ÜCø
!‡^«¢h,≥ﬂ8Ã√„≠…iœ]ÎÄƒ„'k≈„pLk3∂úÅa]Ã=sÿvlõï∑≈©.YÁ–$˘ﬁGñó˚Â*íO-«ô§0…ﬂ;m©ñ™Xœ£ŸÉÑÍNd.∆C,bÀ®è§Õ[QEwxu{ãºﬂÖapª¸e¶{s¯É î?	pB±Œ‰õÍ°ŸvQ•P«∆çeyœéÓ∞eÏn≤à(Êñ∑ñ—^˛¶D¸¶D,™Då=öæÈeÛ˚ tày]SËJ√Y9¡ZŒü8ç2"m‘kﬁÜ“OÁ±ä∆/@ï®Tüı:˝~˜Úeo%≠·ß÷ûâ∑Œ7ÂŸ7ÂŸÁRûÈíkÁ_ü °v#G—∆`DÕ‰∫…‰g›Ó≈¨j—Ï‡ÈX{]JÔ‹d√2 ëk5ãΩ∫$¨ıÍ¥{´<ÌˆxF∏´À˛Õ’πå†©Õ≤∆l˚¢=õ¢∂®‰ôXÙQ^Û#≤‚Oiê`òJˆé*ã∂~œÿﬂÆ≥(¬I¨≥ëCÃáﬁ0Z'iMÚNË`úrºÀ˙C'è∏t‹≈Òoç!ÂªóìàbÖ¥÷Qvé“qp"#√˝@∂	ª0Bëóù≠nPù;Ië4•+ÁçnEÓ1∆vÖ/@ıÜ<è`IÚè+:`ˇ§Äñ‰ Rv‡Ã}&ü2e*sÆtr ÉRZ*öB"„‘N\Çîxw jx…s“ÿ'äM·G/
≤`ÎZEÇ‚é∂”§Où≤!I…¨Nê©Eé6qlπ¸6óÁ¬+:J©9R€öÿ†D∫js DX‚‚f¢Á<a±r•ªù⁄ßÎ>9ß√ﬁ‹N≤;òwîy-ê√«ë=NL>qVßˆÃÀ4Z }Ëäú0KáC«¶áïΩ Ø|]§?Ïï|”yŸÌıo^c~˝´ããWó›˛kÚ™§4zÙ≈\$%â™BàÈumœ7OìÉ∫`˛i9iﬂ◊—Ö\Ü9˘f|˝K+múI~V”?'?ÖËXÅ¬‹f,zäÏer1Û˚E·>“î•}csÓ2ë9\÷„º"~$_	Å˘d]c:⁄UPêW1‰‘YÿñcåÚr•âñÉ|®uÖ¥™D∞ëC}û⁄Blcë`∫4	ä»é2¸"_∏≈˙πYø® IHk6#e@ïB)u$r?1≠g∆2“ÑÌ◊í[S˝¶‚È∞Xí¿ÌÅ∞Ãõ÷( Y:sóåËGsò√Ó≤i>"¯KøHŸ≤vd˘ªπfCs'»Ω«¢˘ó®ª†Ù”Q∞ëö≈Î≥÷H æ©(cﬁ^s&ˇJMò˛ç˛N`ôŸC{‚ÖµoÂÚ÷ª-b€»^FÂ¶v7|∆›ÂeöÖØåG	1E)ínËÇéNÁ3∑}ä[@KˆüÇËFíü†≠!ÿØõ0µ —ès}JI˛ÀπâdnaX¸	»xBú[^Ï’±0◊ÂŸ´SrKÓ“'…∞∫˙Úd‰æ©+◊†> *gÆ”≤§hµºï°Ëz‚“€£RXO{±XTMº:∆Æ1eu¥ﬂΩ´ŒbƒÍªwœÕ±79z˝ÎuÈØ÷¸‚t‘ù9ø©ò?ﬂp«‘?*ΩY…˛†jÂRSÃ;∞Ä˙∂ìój^^«Ö”„ß•∞Í‰AmåScYX¬Z)B©áò &^¨	‰:n.cÔÖJHIr&¬¡éV·£:üÖxÎ»u7Ñ≤|zM˙Ω&—∂}BÇÕˆ£.TêÏée9Úœ⁄ =a™÷÷E çiæä-Ö†¯IcMä˝≥	p∑…6G¶«¶?ô}û¬ÚÕ©cÿøúQ£Q€≠Lo≤-8éˇG%Œø+˚õd%wz˙íÅƒ7Ê7áò¬6ù¡6›–ôÀtXûäﬂâÒ≈Í¡òGƒR‡xGX˘f‰ÁË% ,¸_Ò¸DÏÓ£àßrµ≤'˘˙àµ);coÈ≤ﬁPVc[˛∆»ÙPs>BG‘:p‘N»õÆG
] XHÚ!døqbó$É¬ÉƒﬂAL≠Í Öó„ﬂäh;>æÊ,@∆À'í+„’⁄\ÜNYpx√¸k⁄√E ÿíÃ“é	Õ%—1Æ¥©ILµ>-”’
÷bíS‰9Ÿ∏Èú\]°wπæ˙Èﬂ˛Â¥Û∑jµ∫AIØﬂ∫ÈGøìﬁÎ^øs±°∂ı≠g›/N\¨ˆd¥¨GZXdäb Í∏÷Öß"ü≈S›	1vù;´ÿ∑¶À›.WÕf·MúvíËc_ÙœÔhÆıØÔÜﬁ·:s~Ë®àê·‘ˆ~3Â7>≠„m¶w-WÔcb'„€•±Epß§Ó,¬ûÜuyYk©„D∏≥≈∫VdùÀ§úÔÇΩd¬9°º!sêLÁ-áªµ®¢·Œ≥≠Ω}¸ˇ¿r8´D≤«º8]Œ48û¿ô/}e»¯∏„i&∂—œüËƒ¥ÅO(YÆçÑ“:Òê 4gêŸﬁ±ï^ç›BVz„w∆œc∞%I∫DÁ¥¥7~»&Ï≤åyªÖ‹ﬂ±OÅ√êrÅé*ô2ˇ.>lY‘ı˚ÆiÿËe&Òπ\Bã§ßxòU.º}ôÉxÚz¶õs#ø©UÎM:}À
™¸+OÆ‡¢Ìu/^ù∑˙›´ÀÁ“â+¸ƒ≥yÒbYBZz9≈P®¸õsÂ\ È¸≠}˛™s%˝≥õN´ON;˝Nªﬂ9ïN]í«NÈ»ÆÀt∏«Î‹ tòÄÌî?yË0©L(]|∞•3'ﬁ<¯caÿ>`:£™å^–cÇY«åÁ‰5†Åèe9»ÜŒûíôÎå·ˆ¬B‡ƒ√BA¿êy>˛tgn{∆Gòt&•K&™‡ïpË—©ôîtK««‘¿HOkIfswLA€∞8’µœFZ˘qGÈá±™†Õv}s*∆ﬁRèõÁ>îÖ˚&Z˜$<ë÷>¨ê EÚ∏‰6˚ª$À“∑º©◊≥Nd¿5§U”c,V’ÂKD]4!b£l‘EJ∫„(ÑûIKÎË]Áo›æîZh\ü Ä÷8X‡ nIy&BœE·ŒÌçMçó˘oÊ∂⁄´ÏÅPLõ◊«ãfÚù<Ãâ–≤ª5ë´ÿóÎ-ƒP"¶†WÓ∑&rüu‰>◊Úˆ’ÂãÓÕ≈Í`æb:ƒßì"œ®5[="ﬂ]5Ä˘Kw÷k)°Qv~7°qüIv{[⁄—»è[⁄Ìñ…íG\/FQ¯	d‘¶FFµ∆Zµ)óQÅH¨,zfÂ¶]π¸≈e•¸
	"õ,Á‹eN:ÏU.‡‰d¯:üÅÏ{¿ÈÅ2^®ö∂¸EIe"R•RêÀ7Má¬"Å”Aì,‘£¥}º"…ïüR†âH£7–§ÚÊ«⁄«…€B·à‹‘¥,(Wá≠ÂAËx∏;Úà±DIät»XpigM9¸Y1ÚDfùôÖ‹Q'∏3xﬁ.8Ì≈ƒt‚©B+3…)HºCLΩyQºb•å@7Cm:]
Y≤É*˘â“¥!tI√'jX˛H¥Î}G∫∑ƒà∫SﬂÉØÀˇC,Û¨kÓp‚Ë¶Áÿ[Äe\¸B)Ï±aŒÊ–±ÈÃ$^U‰iW™>—yK™+Æ}‡q®?Ò_& •ÇÃ≈ƒﬁëÛ\s‡s´¿âáÎk¿¶{æ>|˛–2èˇ˝¸kXù‡¯4ﬁQŸ rîŒq
Xâg√ìU…√C⁄ûˆU} è|øÁw∏]5Ï§Ìö‘ÜÓ3Ñ≥¶0“—¬Y ÿπ >∫ÀÍ*Cµ∫å √à%ŸÄG=8=ü≈7m†XÈ!åz∫„\Ä'|3 =åP;∞z™ô≈·ˆ‹Z—T˙ ++7µ6Ã
Öö8–∂'Ü√í—«–ß@î…–®˛6◊DÚq;∑	∞4#g ˇ;y®Â·¿›>Æ`¯-√`dÍ·ÑÔ îU«oaÑ˘2P∏·o]¿1{x¿òÎq7Ä}O€Àç«H#W2!Iı(Ê¬uÄÿŸﬁw´Q¥nœDdl∫äÑÇoy√†)µ ‹+¥Ä	eJõ«/∞ıª/I.c≈gV»≠?∫(÷X]K∫r}y6ºÊß≥·È∫ñ	[\ÿ⁄x*aıÚ…Yb=)ãibˆ"A´∂≈˛Ø∫∑πï¥äÒÖLOì4uÏ¯≥⁄˘Ò'œ‰è)ç…€Õdæ™›∏äG!ˆ>e6‰yªj∞m;πn¨ù6L4<.ô·1eàiiãúùL\Ã5Å5–ñ®M¢H∆£‰‘ôÓy$2ˆGÂsÉ¥1toh≥QW1µ…]Uî¡ã{rŸ∂c'06Ç@ÔT’ñ6∫˙qO1¨“84oÕ!õ3:J≥˚ÄE¥´ÚHOt(OìÀêπ€SY“"ÁÕ"°≥+	¿∫p¸Brpî C¯W :ñù˛¢Rgπ<éêx:“ !~ZgÓ'¬\,ºí…’ŸTwsl™!Åh¥i€,FäVÌCÇΩ6}Ä‹a2ïßÅÂ“qf:à2LLQÏ§Ä	#óSèq© ‰¿ˆct»5c”Vq™Ÿ±E^>∂R4òhëŒcå1\êS√]"oœÌ=Œm2–8î4á>KÀJ&@≤A¥dòõ∂õ∞]$√¿¶-áñ3£#”`	Ã¡O7Î∏U,≈fémån3}d……‹ÿ¨`«Äï—-`ˆPx@˝—≠ÀZ8Ó¶¢ñˆ@BPåh]w…G√5—ª“#,HãY—Vm≥¥àC∆AÑSÒA™¬é\‡\s»¨÷3Íõå6Õ÷Á©4:˜äßPÜ¸·q_QcpƒdU‰O*dbÕKaå Yz—\ç^Ët;
g]Ê Ó¥|KÎ¬ñfJÀ¢¶åí_ÚMÊïUÖ.ÉŒX	·ó¿óFyd–…¡ãµ1E—{@…@Vö∞b$£*~‡ï≈FÆ±‡®¬G‘Îæ‘MË-ßÄÚ@
»j
Ê3BÁGì.ÑÕ`—@"Åt¶Å˙6¯ç•}ˇÉo√π„y@I=“X‡9ˇN√•!biX‚ógœé‚íˇ‡ãÔQ˜#zíò#J^R∏|L“Ííˆƒé/ÄÅÎ‹-YPüãµûÅÀ√2«"*%1|e+∫ˆ&|û∆.f†÷tfˇË˚$'ß¶1∂∏T·fÊ≤FºY∏Ëü‡NFsŸhL…Gd~&ü≤
lBé 6˚`Ö´vóÃ¸ÿ$Èßh˚*yu!)Ík°ÄyÉ›Â∫*ƒ“K}≈ª\"ÙE≤ÎkRaæº+Ö¨±ë»Yo°Ê)K¸tÕ‡1–ù$`4å°˘±…¬ObHªô€6èÏàŒ1y¯Ä¸}Ó¯∆9»^>÷ò eÊçBØ€ 	]$Bo>ØÔ∆ñÌê∏öƒ¸√]Àü|3ÚÕ‘‰õ≈&ü˜<‡ª,V´íıí¢{%'ÂY§ÎvÁ∂0ÅˆÑ?®≥àâÅcô]}ä$äÃÛãesñ*âLä¿¿ál£ﬁ©0éì9¡ÎÛ/fˆ@”ö§°’lic(∫b§hQ“Á\;Äò‰QP·4µ.¯¥qW¡∑!~'Ç«€≈ôÌï£k*3õ#†hsª‚S,8RÒTŸè6®Lä≈}.RV´UÜ†D@ßí:êLóIJW⁄º†≤4õmaq.qH8•À% ADJ*≈“û<	’ä<÷|Gí-vï[+Â8#Ÿ©˝ˇ{WÌü:}r›ΩÓúw/Û+FÀÓµYi\ èW_bµ•aXõ¶Ñ√Ü%o%%K‰o£N1z=qÛéG√+NÉ±˜ö©Ωo_]^≤xÚ=¥jD©ã∑“˚≤¯√√Ê{∂Ù>o≤Aá›Àó!∫úv{—(Jd…ª«ÙÅ›–n	â dDà£wÙÄ˝©¥}ıÚ≤ã3§s˘r-Ï'≈`5V˙åÇ˙ÓÚy5®/Ñj¸0˝Ô˘UªuNÆ^º@L"Ì´õ;„óùãÓeó†¿Ò‚º’;˚vŒRB‘π˘πsC.:W7ØüÏê◊:⁄)ù:ÓÚå≥W„Bﬂ/6H=∏8!€D’¢<≠Mâ∏∫dê—Î¥_l|ı}R ´Àﬁz∞ ﬁ(èáêà£i.¬√“ÇˇÁÀ÷–cGéˆ'Á›ﬁ‹"óWßü‰‘uÏ∫òúv[//Øz˝nªá€ª:Ô(*)@˚≤åœ˚«?»HQ¨ﬁ ∑‰fëÃœ≈Ú“ãé$[Q19mbx©£J¸nâπÃ»π˘´r·¨+Í+èºLáFÇ≤¬ÇÎŒWf«W÷√»q°ã÷l¿îa”¡ä*ÅË6yr∞XbLV—I_µ˚ªó˝Œ˘y˜eÁ≤/Ä(9øzπn≠)ﬂ«†{Df>¸ÈQôtî2?«∑pE©4aêåÊ2[Z"•S©g‡œ-/#vTƒO#$π#√6¸d⁄#sÏp}n≥”ˆ’*H!ïÃ{∆‚Á	´ä]J+}≈û˘π3ˆ–mó”ïé<T∆÷Cw¶:óYsÅ√«€à≥®NçYπl9„-†Æ#z«<)u*ü‡É§ºè#Væøg˝?¿0Z’õ–†lèÀ5¨uº˘^éJ‚w@*ö¢.·GA˛Ôrn˛)¨„\üi≠˘àzÂ“õﬁ´vª”ÎΩ-mJ%ÿàﬂ ˆ’Æi›\ä˝J˛◊ËıÍ'±œÿÉ*îñc«àúû5Z&¸Ë¿?(˙Ú´â—Ã$'Zﬁ “û◊.d6Óˆï2¨$"≥5Y;í∞*;Ã©È¡®&Ä›â⁄w:nß1‡^#∂s5ÅhØîC£h÷Äı¸¿W˝fÀΩ†CßpÈã‚¨Ç∫¢°∂∆^-]X£)‡Z5-ó»#*ÉëwgwÔëõÎ˛V}∑πUˇwçx∑KOÛÀqxgı©è˜ñn3˛¯ÄÁ∂ØÓœ:¸Úù·?G’‰oEìµÉÁMÜqû∂dr`_\Ørr~@p¶^2“5MΩÂå|¡k≥~⁄‚…yº•ÄbºŒÈŸŸS≤pI,EïáÎ¿8∫tFê¸·Z@Ù^n
∞µÜ´‘d’eQ’%mÅ•t~åúrI;ª[çz}´±≥œã6ØêÔR^æY‚ª¥®Æu=˜s®V2Èsg¡ußØÖˆ5ñ€‹±Ëj∆‘m
Uÿ:ïñ3?.¥ÃÿêËäÇ”$/¶ÄÏ+,û¸5WCæ0L;(â”r©±~!d!CA&Ú"Ù˜≠6Sø¸á¥r2E´≥[¡_‹âÄØ]°¬≤,|IE_¢7»´T${™bÑY«!ùZ:'Q$ìa*|BR,1æA√øÑîè”ºZ∂nÅ!¿ˇzñ…˛®0Ì´[™≥∞À{¨Ø&ßÀ±»ë-J“Ãö„µ’Ó
‘ Ã¶Ür%ôﬁ~%ñˇ+û1È‹M ˘(≠›∫Í[IÿHﬂfíäï˚S@∂h0~0∂@¿E«Ë.wk√PNæ Cºaßå—àó∞s6‹:«‹T¸Æu›}˜SÁ5êôc`ÌôØ5<ô ˆÛî⁄sRFÄaº,:<ÉÈ&˘aÏˇÖ7∫‘Á≠)À,8úóÖÿ¢ Á˚ßπ—^è·'{M˛5ç§Z°ùÑ3bïƒA%≠Ω´CòπÜ≈´±#dA/Ãk7æ±$…Î’*0›ôüöﬁ‘Ù0vÔÌÇöç’9>iW±Ur>hı™ÎRU÷^Fã1¿MBumäZ± ;ﬁ∏y5Ÿô&âÎAÉåˆ⁄X∂ÿìO3√º9lœˆ∞î¬v≈"Ók8/≥©ÙAúü,%ƒ<èb'ﬁ. ÑMçœjæG≠ﬁ4'§á)˜qÈ˘˚à⁄s+ò≤ú.À(ëjı±‰>«w•b¬DŒÙÎ*
áØ›e
Æ"e%µÂÑ”äÕΩP±)r)
‘_»H9ìRB¬gV¨(°Úö›…8öƒ-”E&bÑ	jœ»s6¢ä¥πø4û%µ\÷¢€◊ €∞ÃﬂËß†Ÿ´∆J~⁄≤·#îH–Mëèr[oÀ™	¿˚ÒÎﬂa¶Tﬁ7≠Ñ›äì^H
Æ(¨~aFç"™Y˝ Oë>R¢$‘jTSwë‘$/vì™…§•ïπj-KÄZçËŒƒ“&ôëí'Àr‡≤‹’Å˚¸≥¡Ö∫√†˛[Dﬁ˘◊z¥Ê9åﬂ˘˝àÈÆgY/ôÔÓΩnz™OÎw¨¿	˚~Ó,(å]¶¨…ß©◊Ò¬reçÖJ˚‹e‰˙åBøŒM¯%ÅgiVÑ¡]†¨ﬁî’{Õ¨rüªªÀ“ÇD5Äò>k¸È-ôéP›]b 2 o¬‰*¬hòÈﬁ4Ú<‰Ãôùpgß˜¨Ø¿˘Ä˝-ΩH-2ímto'G Y=u~π˘˙Ê€R˙‚ƒæ}”∑h‘u“⁄-k?∂ú≈…òMC∞?4•mŸQv±JƒÀ1Úó4ç	§Ÿ“´h›	=¿ë£)…HÀ˜AHáúÿÜ}Uˆ‚Ã\âl¬∞l„ƒDT%≈ı˜Y•¿tõ œµlº˘pú‹
zTh7£é@úA„ŸJª!xk‰Ìà8ç‹]a\¯
ª‘YaW|TV©ﬁ(∫'qEŒéƒS»€èÑ¶)≥-iÙq©èy9≥Wü.W‡ëƒ7÷…¯eµõQ≥$’⁄ãÂ»πnçªQòJYÕÑ‡G∆à¿€?÷
Æ∑ã9ΩpIÇ-Yﬁ]ÔßRÍFaä]â‚ˆ3I1•¨lé;ª∑¯u•räU˚	® y.’ãdP0ΩÚÃ•Ò¸oı÷DÑ≤è? ¯0>6Ñ%ôãëåïg.÷ë.(ˆ¿ûåŸ>T9…l‰¯)b'èÏ∂¨©(BÕ df∞2$XÇZP”†Ø¶Xe…Ú†%!dôÛ¿26#åSﬁ©(rB¡Î·)∂ÍrßtË∏∫™∫K
ÉH“>.ÊiQn±ıq”V6\5a ﬂ«u	®(;åi_j†Ee∑ä÷Z¯:ãâØ∫p`û‡®ÿ‹6r+ÏÁòÈ·K·˝+iº‚ÏjcÜ:êPùk.P]pSV Üê0 '∑X”‹«ÿxùíáT·1¢πö%Zı ÌØÅíc^∞D´Zè¶©{,)°ŒŒX¸ö≤(VEœï] º√˛’(4K…≤à’$Iíb(sßÜïSJ
?ÑÅÙ=tMÊ∑ ﬂ‰UìÒ™Ω8R¸PL#î¶*HK∞.r{bXµ«4jÿØÙÄx√ΩñjQ÷-¨;öÃQ«aø?∆yº˙hâ˛„	Æ™∞)èèìÒp8\#1úÑÎZóÅ€+††BVaèŸ˙·è˝êgÛã˛ÜB≠AZQ≈r=dΩ'–VeR≈Üå‡]•∫™âŸcÂvè]u¯Tîg6»óÂ5P&¯∆∑Ø.Æœ;˝NiSÇœI)√Ïf•”Ω§$∂”îJß;ò¡6#}J=P1u EI<`§)¢_ÃèP<@‚kÒáàÆäi ÒÛp5àˇ)’kµ?)|ÚÙ[+€™<˜ãπˇëÖ≤§íMÄ√ëã,O |¯	5Æ~_Ä?∆ﬂc:.M¸∆Å™1†ãπø*:ë»Bäì*∂St±Õ´e|jtzıÄÑD.é≤ùí}û—¸4jiƒﬂÂhò@h•˜@2së–[àôQWj/9#´ªK•Ü≈…°\jCÊ.¶°– k®r⁄ÑU*zÓ-`µRÁ’"ﬁE–+ÜíTï˛tS”ÜõCÓ8´|˜ß¸D⁄¢ÔäêØV≈_Æq¸•ˇ˜ø˛€øê”V˜¸5∞m'‰Í‰øtx‡˙Eßœ6ˇ˛?ˇ˚ˇ˝?ˇ*4Å˜OZ}r}sıÚ¶”Î)Çÿµ’·”[å 
ﬂ3î9#Á◊L™)ÊÄ€©√ƒIËRßtvÂ-4Œ˚*ﬂau5xï0.=p¨}x^zSµ[tXop
éYØΩ–ù≥<\Mõ6<˚ª“Cy’£,#nÖ<'P˜+'ﬁ7ß‘ô˚7Ù∂îŒ›ÑMÑ;:xê”V.¬Ç8|¶ﬁ$uUÃÆ ïDâ†Æ§DòqºNf¯bÄöñÜ„L∂ﬂ®å8*Ö˛d∂ d=¬ÅZJZs‹òì?=⁄, ≥Á>¸Å+	í%ΩöçV"±XW–ﬂÈÒ;3t¥âÚT<ëPπõ'Â}πRe-œ, ï*ª°XŸÿ◊‘πsEÃ«˙=®ƒûlâ:QrdÓ¢0Tì‹`de∆P°ê:8øßÿπô¿¡m$™®!9€!„Ω0.m/ÂÎöœ/,‘îü^@≈ÃHä˛¶c}Ù%ƒ˙Ñ‰!R:q≠p”)ß?°¨bÙe ÁN°ßÎ?êÌË¡˝˚‹tÈ(x≥aô´ŒÒ”z{ÂSﬂ6µË¿]◊,¶øb?@já¡W:
˙¢sµ_Õf±*UÈÚTY´h˙ˆF'ÓR	 ™2å˜±‚Û»≈ÌQgIö≤ÜGcIãDúfÃ|∞î7®*0¨HePö.∞hÔˇ_ÛV÷◊†∂∑˘Æˆß-¡÷¯Ó«⁄ü0¢]§Z—7&[Ê,$t,=„Uq±tßˆÎ"qΩ(˙~ÒR]Õl]‰ÿcc˝ »{
_\‘2&ÛeÀ”ZJjTQÛõ"æp˜
TÎÓÆÌ∏6föó‹zR5¶`dØcïÚr53|Ω†>Æ∞ö4¡KÆqÈD∫˙—ƒ ¶›â±0\Ù⁄fLÉ≈¸Ò
≠+yN:ä7£<ûÁÖQˇHqZ√…√ n‰1'¯O⁄«<è +fTW®ãd√kà§!Ëo ìwˆÄˆØáéà˚qË¬EÂ·Â»&ÃI4Û“LÓ\.OŒ?róê5∂ˆlã¨æmı'ﬂ6êX&¯Oj€ﬂè∑M‰‡◊‹µ¿éït¥eÎ„”€KÕ#Qî,Æ'zƒÑï™R&q‘‘‡¨`ÒÅØ_mæ}ö¸@,!j6‰Bù-U5Ø∏úíÆÿ'VåhF%#‚≠&œÃj˜©§înØáââÉt`/^ùØ&üH2*pÃPyÿPî_LAÖ2Ÿb(h˘h
Œë¥B]â<{ê"©Çƒm‚Y:Úº6ÀVNÚ4¶d√‘∆ÖZsoùüGg)±1≈)WvüJó"Ò≥–m∏?^≤D#ño)…≤î+{+D0
A¨qUØıÎé6øÄÜ*’CÚÆ´√∏0&˛˙a
¸fJÅˇ#áÇ‘±« ´T®®V≥NnkÉ9·ø∑¶eâ)‡UuπM„‰ÍÚï&±J’uäçµ∆ îÍ„TÚ•pÔ{r5¯ï≤\aÈÕßX PñPΩL)MJÂIIÏqVÂ8/KÄ<{.Ø 
8ñQ®›ÒTEX
í¶»sPÓ”Êƒàú∫¬ƒ∏ÈåJqjñ=ïçI≤™0ÖÿZ& ¥WfÇ2ÀÃj3µ,/öWÃ“–nﬂtNª˝À÷ﬂæ:Ì¨dLE!__˝‘©‹ü¬HU€Yî7´æ”„	F7´ûeiπ≤∑˘∞2Î®}o>`–∑›vlêÔ|ûj@NËs+èÜâ
‘†∆ÂÓ©Õ_c`¥è… áÃ’–≈⁄°ã)‡U8ôH:xyµ†ﬁU–rn¡‹'Jæñ33ù>À%Å`ÇïÿKAT¶<1à®6úåX±RÊ˛cvg¿$K‡—¶.ö±†ßD∏9WG∂"´,Á;#côÕL¡D.%%¯Vπè‚ÂF¸RP™\y=Í˜§∫—úHq¨A©vˆÇı™ﬁ–@∑`2©ˇÃ r2,oX ~Ä[`!Âwõ‰^.BÂKV·æaÖVÊ6(3Yæò¨ßrgjxæ±®2™"531ÁÚxÒÜ\bépöT <€õJÜU<=[˚º’Ω '≠”ó¿}˛@XÍ()=˙]ìpÜèXà*VÓ1Jóƒ9bqÓŒl… H“p∆-ŸCad”√|º&ôòqV+ƒ«£∫¸¥Èå0'œkDL® ùM:„Bﬁ|243bi0Y’Ó¬<èJ∂……|LnËÃq•ª»ﬁQOô=.2◊®°$ëéÈù„!baÏ3˙"]»·ı¬Ëb˘hÀRO⁄ﬁE±mﬁäê¯¬¯Ë∏ò’Å\∂1¶STï˛l¿]&€«®5k°ûy‘Æ¸≥oH∂¯6ltt˝)>˜· µhÿF(äﬂìSË±ºkÿSTåïm πí+&®ﬁ£Ü;úF"ÕHuäQ8'ÜÏÃ/¶?âz7∞é8Qça,”óå¥EÿlëçÎ2}›LÄ±hﬂ@{LÀ“f´¡hxÈ›ÛˇJÄ(A9∑{sê”m/†vá€◊u‹|Ñ#¸¶ÛOˇÙˇ  ˇˇ Ú;å
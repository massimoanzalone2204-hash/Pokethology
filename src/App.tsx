                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                      ...
                      <div className="bg-slate-950 p-3 rounded-xl border border-cyan-900/30 flex flex-col items-center justify-center gap-1">
                        ...
                        <span className="text-xl font-mono text-cyan-400">{selectedMoveDetail.accuracy != null ? `${selectedMoveDetail.accuracy}%` : '--'}</span>
                      </div>
                      <div className="bg-slate-950 p-3 rounded-xl border border-cyan-900/30 flex flex-col items-center justify-center gap-1 col-span-2 sm:col-span-1">
                        <span classNamexúÏ}€v€Hí‡{E∑∫DıäIâ≤¨ñ‰°(⁄‚ñn-“UÌıÒ±A2E¢l 4≈RÎÊeÁeœŸsˆeü˜ˆ}˛d~`˜6"óêô )ŸÂÍ2g⁄%âºFD∆=éJ>ΩÛ+o˜gwÔ»≠c˚ïÅcçàÔ√è¶=Æ,Ãu	k3\vÂY≠FÊ≥uáÜG˘ì˘®t‹πΩ•Cü¥'Ü=§á€ﬁÃ∞èˇ@üC|LÜñ·yó∆îÒ9‹Yºø©c;¬àªµZÈ¯ﬁ£ÙOGŒ'zJ}√¥™î˘~»Ü$ﬂ{nY‰˘}nÎá?~ d£RŸx–œıp{d~í?T>
Hû‹oˇâÙ|Éo”òz‰O€≤fíÈ{õ<æˆ√$ßI’¢ˆÿüêcR√÷e˘
`û‚)¿FieYiîî€1ŸÕ[a–ŸìÇN≤ΩÁìÅ„¬{ïA¯{˜y≠∂ΩS#≥A•^:æpFÊ≠	}s†Û∑'ª ß÷8vÕ¡*C«Ú*u26föÁFujÃ eo∏EÃMrt¨ÿja2ÈÚË˛É7¨ òYW/™6Ãç¸„ƒ|Ä_Õá‚î„äg>≠<o÷∂õ∞	ïqùπ=¢£`è2[’®ë[ãﬁëøÕ=ﬂº]V‘_Pj”ßSØ2§∂O]ÕöŸ\•8b$?÷∑ıöˆÏ£3éé1ô/ö≠πÍ“ô@Wﬁ®llë≤±ôÉèÚπ›m›∂„ßT|¬HJ[9˝¡*8 0{Ù?vaó≈Ú¬rÈà˝†ÌoÛAø`√‘Ä˛Û˜ÒoHŒ‚o§◊oΩÍË∑0wõ5§èMySF∫r^T>ÇŒÙ≤5ôæÈÿÜE. ˚V ôSl˛OG¸Ñ˝85|„¥Ø¡i_Ä œã!oÕÈªôW"úx$U¯c
HqãâM8]¸ÓËàlÿéM7‘ß)_∞î¶∑òØeønp>Â9nuœ/:ó˝ÉuhUÇ*$	cÅÕ(@ÛVÖ∂Úõπ¶„ö˛íùﬁ9∑¶˜ŒWr◊7›´õnˇÕ#NBœcÜÀˇ‚˚ÓÓò˙_`ü	–Ç
ÆMÀE˚w‹o›ºÍ<Ù˘ç|‡Á[∞ã∞ÓY<›’ï>ôô_ŸMÚdZ.Ïp0˜}«&äy:v€2áèÓÀåÁÙ®ﬂı‚ùªöQª|kXU.TúŸ]eüÃ‡‚#¿hFw’zs¬_öK|g·§‚ª.}≈¨kÂ•5xh{Ï>´’õ#gQy[{_{_oŒÓﬁª„ÅQﬁŸ›j‘Î[çù˝≠ZuwÛùúóRw€r`-∏0óûÈ)Œño∑Fö+ÙÛ·ˆ‘¡µT3œTOÑ:‹nŸÊp„⁄•!U!¶÷–ôRê|‡ﬁﬁ7=<Ï£{”Z‡◊±Ç
l@TÑ∂!ú$_¡'˝π§œ∞oÜ?≤W}wûxs;^ŸaÿPò°¯ÓÉt^âﬁ√âmã˚pÌ|§¿Ü¥ùÈÃpMœ±{ T√ïnI‹äô≥)…÷¸ôô6\}¡éÓ˘◊¯≠‡äq3˛grƒ£pÜiG]îgl¯˚®¿dÇ¯œÈGäy&€ô∑§Ï!öy/™ﬁ–∞7	ˇ∆æî7ˇLÄ¢.œåôoÀñ9û¯â˚yé- Ù(njÙÂA<˜ËodŸOÅ-…Ÿ|@^é{Cä]ë{?Ã¿{<(ƒzÅNpïŸ{0∆ß¢|]·À@≠¿¥¬∏iäa⁄@s¥Ôâ|?\ T=§©•¡'òhVœ6£w¶ü◊ULË∞•øúQ=`/Ïqiãåå)Ä”¯Ä4ö[Øá[õz~ït%ﬁ˜Ê0c¶ÄQ©ÚKÂ-‹´Ô¯=Éˇ £O˙ÉÁ˚d Ùx‰:≥ ¿öªï∆ùEê÷ﬂZ@x'ÊhDÌ‰n•â ¶Y¯WíLãïæ˝åÅÁXs.∂F,zÎWÍ€ªdQyæG&¯èp”l◊k…KÇÕsÊ9sLº3+ÙÓUP&(âT'gÅD~
„ª√Ÿ	¿8tΩ	H∂®ÔÃHoÈ˘tJŒ®ÅW‚â·ÿ*o0Ò&)õ\åèæ?FÓ∏ozﬁÂ;DuOÜ-D·o@¶QØ]k,·F§,f¢c÷ëîèIøªÄŸM‡0”E6˛;©õ}g%‡†QìÈ∑ÄWG-òzÅ¡W9/±∑Uﬂo ;— VbgÛ	∑[≈áıQ&À‰"vaª|MæÜfR_MnMß¿∞Lú«ûî•Ÿñ&∆lx•éπ–©48∞ùÖkÃ»b∏öÉˇ¢ZÛ§ëË:‰˚8Øº¯Gæ⁄rw∞¸Pyo¡NBŸëf -@¸äÿSxRÑúÇ‘˝ÜúΩ>Q∞pìÜb9i)ê§ÅHR´6Sh¿£ìRÿC®‹≠•V*Ú√—vxÇ $fí3´°‘õ*◊}Ô√∂î3ÚjIHœ∂fÁ∞§£î®q/ùcLƒ[ ñÑﬂ]í˚",	y C√NH˘˝&πómAÊrƒèx÷p‘ú.ÓTÆ2A'Io"y=í{¯Øœ¬ÛÂ_w"…à˝»é3'¬{IŸf8w=«≠WàÑ~!∆÷´)	(F<ÑR¡ª∞$òb≤&ŸﬂÙ-ÿ.ï;ﬁp3€J
RïëA6rÖoäÎ¯¸R◊Œ˛ºu‹)Õ]É˝‘@πú‡•ëïs$xr¶môp›∑œØz‡´$9):‰‹ƒåv÷cÊhY1@>ÅsÙêã ∂÷±,=ÄÌÛÕ©˘~ÇC!≥‹*{d:ÇˇÏì©qWÅ`nz«{Zp≤ì‡÷d70ä˛ƒ±úÒòˇÅ·_òû˚¯≥9BëÏàëdÙ|˜( ≤6\>≤®OG»◊}FøIﬂôÚF◊Æ3¶:ò€¿˘ ~ï·e–ÓÜ˛}n∫(:âo'~ïΩÕXzX5Ä	_≤m≥aˆÙ)ê«bŒKj¯sò7i;ﬁ‘í–3ÔÒÇvJ>l±°xâíêåÓVcËõüh–Ì‰àîŸ˚Ø®çÑ‚ïÈ∑tjX\ùŒûΩdﬂÉ∑6……Ø‰ 1ç?K∆ûÃ`∞Ãò±‰–[”ïÀ ”ˆí›±êœj2€ÿ|QEÆ‚=>AA∫Yìd¯>2!èå˜Qp¿Ω• c=nƒ†ìÇCz≥ñˇ»%z3:!∑≤“RΩŸ)Ω}öqW]0$zÏ¿t$N≠î)2?≤CÚádõ‘kõUﬂyâbvπæ)Öz÷Ù%B|D.RÖÀ¬qÀ9Ωí?ëùjcø∂ø´Èµk'‘˚e\Kπx«§"LØ7§c-X£«Ú≠Xﬂ
ﬁÙ|Ä3ñMsëúf£⁄®ÌÓ5Úz5¶úıÄ‹K·#jÇ˚b1àî√ßÀÿ«¬à˛⁄ÿÿå¨€ïÌ17/lVˇ,Zçõ¨’%ö•04sƒ›3g*%/™Êà¡j·√FŒ∂¿©@;{hÕA6*oLÈÿ‡√håx1õÆπ!ﬂ8◊_8Ó«◊ÆÖÁazΩâi/Å∏gOÊE5Q>Ó†„O®˚¢˙v√πΩ59˘‡›lºtÅ}Ô±~‰SL˜3qp ¬{õpë†ü÷fÍäÜÓ ¬võ•ÿ;Pcn˘Á•[_–ŒÙâz Æıi:N≥h´ü…zÂΩ˚a‚˚3Ô`{€5’±ÈOÊÉπÇºÖÜÏ°3›∆é[◊›Ì†œÌ©·Å}4Ë€l €Èçÿ˛˛>ÁW€Ë–∑Ò˝Ω™3{¸Aäƒ¿B£Oﬁ5ÃUöÄ*üÅt:†.£"å˙NÅ& &o%h1¥Dr∂«Ë<›‹L·R`ÌåW≠ΩNËØQ6ñ+∞´∞+±ã©±üTë˝≈UŸ2π∂à:{MÖ∂ÅÙÌGË¥=¬ûD´ù—k£ª Ï&±	`}ò€¶2U˜
 ÓxÎæ¨∂˚q˙Óu5ﬁÒj3*o˛Ëq:Ô∆ns´ﬁ‹ﬂ™◊ã)ΩaΩô·~¥Ä˜,¶¯éfRõ lnyrPf˝k¸,äi∂5^zè–^ÛuW_Î‹ﬂ6∏¬∫◊n]n®˝MîZÎ’ΩÀµ>#i5Æ†≤U°Œ∂òfV™˙¶{Õ—Ω”æ™úYæÑˆÒ:Xù?ç
zYdSüãí6Á…â3Z≤/ÜYÙJyî÷vW™≥}ñ—Ÿ∫92°÷¯ Ì}ªÄ°Ák´†&∏7Á¿`¿FXÛ©b˝ÍÇ]c6A}#j[¶p<Ò6˝Äû“Æ9T≈ó»Æ)∆ƒ◊q‚∆mÜ¯’ê^œ!F#˚%laísÀ`€.∆0∞Í!ÍD&D}x¬·ŸÎ”∂„¬B=)ìoZÁn4œÙIó1$m√Ö∂x’∆(∑&ü√P≥0ç&zZ6»t¿léπ∑Ø sRacî›nÒÖ¨ÙÀSA≠ËagIì€Éƒ}¬˛Mç≠éâÙÆ;ÌÓEÁí›áóùı“◊ä›c7ıòy⁄Ø≈î\ªæˇtﬂÛQñë®ØêcËé§≤1Hòõ’ô1Í!ów∂»FmC„[(ÊLÿ»É∑ÜH»ôSI9–Ì˜ùÒy∂H€]í¢ÂÊ
êû‚.p◊‰•u¸èƒÜbugÊ,Ä¶Ñ@åá™G4»KYÇ}ôHÜ0™ã=œZÔ¢~då◊ilê)o0SLaÆ+g¥dLT‰Ímê» YvÄÜ&y#&√ßÃE‹XÙÇî“¢J
·eíø#‚p®(r$√Àï4Éüº©ã÷y^»ì⁄ÀWhıD«ÿÿæÍÉÌÄ¸hgH≠≈ìe?d6j˜eŒıeÁIN6/$ V¬‹URá~˛…j´Cóôp˝^~¿F†¯S∫€ƒÿ<ãû·f¢¢†«¢§^≠5ÛÄÖΩÿ7f¬kµÍÛ‹◊ûT±óË∫:*ÒÎ√ ”aqa‡Bì‹»hŸí‹∆â#ë5`±ß±!•2FC—»?	—∂˙w4wèp5©.¢PÃU∏ïIÖ›»◊,ñÅ‡nMÇ˙)>H‹@´ñáSÇs$ L-.1ŸSw®9ƒ6÷Éß‡ù≤‰mmãTÍ˛ØˆıI@EZrÑÒ<rr¯JQ¥°bb
¨î[ß(i'ŒE)KG£*#C“üÎÛ÷“æy£%e	*≤~úìÜ≈<Éõ©Ú¿çß§≈Ì.§7qåS*ŒUFRﬁ∂ıµ@Å∏h˜Ú’ö Ôo]cÑ†1˛~-Mwh—˜àœm}2‹r•‚/¢& T;3os ﬂ—_–∆7…'”0’wÑ/IπR›≠qa7ƒàî·ÅLÒrı±Ã¨Òµ≤;r≠l£π˘N'™‘ˇ°Ωv(Z6¨∆ó,FÃô.™V$Jˇ‰“ãirÒ£û∂9Î)œ›«fjÖJëÀ?í‹æ,(V˜û∞k\õ√áN¯üŒ‡ot®Ã’'J◊ÌÜ¸‡öpp 
°jü≈˜çîmÆ^!wveCáMYeñró∫◊\òÀ£íÌT¬ü‘Ø)è0üÑn$»óx•´µKYxÙ:°ôê‚ˆôv∫a•ßCì…é,´L®0iÑf‘çÍﬂE˝M=üXÂ%ë2ëâd±/äNÖ0Ÿ)N/b]s:o˜‘Ãß~Æ˙G2u‹Û∆gû7[ƒLòœı©9˚˛â1” 3 ˜˜>Îì£vòÖ1ëâ'ƒ2‘ä~≥¿Û:z∫˜${Ë®‰Msnj®ï ÚQu≤ÃáÁz≤ÙLò/ôäZ¶+.éOÚLp¢°∂2 cRF≤jïÜ °F…BJ[6†\s«xSõ‹4ÄUÎff6–™∆©®Œ:›Wg˝A‚Ú,T^Ü4D\ﬁÒ}‡5¯@¶dõ‹«Óu˜¢ÀﬁC)Wç©GˇiÁÁß>úŸ‹ùY48û–ïÒÅ|„Eâ@-ﬁ£Œ§¿È√‰≥˙#Æne»sëKQ<‰b®üwÿ±6g›ìŒ©Ñi:.Z7oHÎ§{ﬁÌw;Ω5ƒy¢´∏¥
Dè—GÁwSö‰nò3kdì;¡›AG2‘øü;ÆZFR_Œh(„∂±XÄV”ﬁUÕ¸0≥ Nlv≠y|2Ω9F‡€#¯—w@|ßcñyß8\Êˆ{©!∞I≤Î€Q⁄˛–ëäƒ|∫Üìf@e≥bFÖj3cøKXD˚] *¢'´Eáœ36ún{¢íÃ@cw”w™≈≤ıÃä•„ìVØÉ	»˙=“∫lùøÈw€π¯ûj©ØêYˆ…#ØÙ‹TlÑˆLëπ–(MÆµ£∑3q—y∞Q$	PÊt÷‰ò∏Fö»úÒ√Ã@gù÷yˇå\_u/·ÏÀg◊õEíÂÂeÌ∂˜ìY±¸Äz`ímZ∞Áì_ïπìu∆≈¥ÁiÓ≤S3òD√âöókr¢,<ùR◊∞x˛0]2ùH∑Ä%‚˘Kãy∆˙ìLìöt}.Ofõòı·!_õô≥øπr	cü~«òt}ˆ¶◊m∑ŒI´ﬂoµ|≈[ƒ#ˆ;≈•HíAd
¸£üó¯?1>Â`FÓ}√ösr⁄yŸπ‘˘'fﬁÕ†Kì∆ö †Òwä6avƒöËr~Rú	ˆ˜À"Moˆ{ømòkﬁì\6ë√àà5,í˘wä3°´‚L†®zr¨a˚˚≈qÊw~◊Ñ8ÛWç I¥Å-˛Ω¢ﬂí qP5v>‚¿iƒ¡$øcº˘±{ŸÈw€Ëﬁ9}÷àBpm`áßhÓIÄ7>5¨œÅ5∞¡_HOHÉLkhå(Ê‰±Po`‡_Ë7-∏Vææ
8_.(âu0—µoi‹iËj%q—ãf≈ÇMò˘EõÒôÙÏ9¨ uÛ]«À’ü;ëéªûd ©d<9C^H¥9/_;ˇ˝è‡‹;∂Ô.ÅB≤Åµsõ…åaøﬁTº0ü{ã`ç¡¸læ¶√‚Ê,:2ÁS2¿§]ïÏì'ÊCúπ¥¬ÇcÀü]cv@6{πòPón‰zyJºT`wÜÆ9CRßΩ|∑güë±àùSÍ}$‹ssq‚∆¶ˆHìŸ
}≠RÅáBI√œƒ∞GQå{O·™≠H~‘…ö◊¥æÁ…†	¿ú∂Ú6˛Ã˚ﬁ∞B“±±πEJ¢ÛLäÙÕÓ*{o±KæÒ@çÑ≈\ƒd‘?ÂnÕ#ã”û•1——ÖV¨bïÃs'¯—}h#Î;ã…w/ení!ÒfπMºâ9¶%«RYíC+©kòv€tásSj)çÆêî˜@t8≈ºŸ§˘—‰À«?u;?ìóØœœ„ò«÷M˚¨˚SÆîò∆ÚàbtÖ~V;©'≥√oñW»íÿüPÙzcn	ù;c˙¯‘àôõø<")¸ﬂ·ıoY·øeÖ/öAGê™û,1¸∑åø›åπwå&/|ëòäo9ﬂ„Oˇ¨suÛÜt˛⁄∫P\{ﬂ≤æ'ü¨ìı]&	hÚÖ˜Ô‰˙ñ-Ë[¶ˆ*É’/íõ}˜qπŸ/ÇîÏ_ yf*»[ú>@π°&Êî∞◊ºﬁcL∏–OX9k¿°“7H¨|ú±7°£D≥Å–U¯ˇñ(öïÀ ÷ƒ‚Ô\Õfp)ÿQ·˜lÀsg6Ç?≈ÁòdÛíE›«KÊqvÕ‰Ï:Qü+ƒKz∏0ÓÑNÿ7Y?A≥ƒWIo∏…s/Íéïı6L~_≠NWîÅˇ o≠ ü|‚Éd›≤:≈r]P@˙#àq˝Ù0°∆ße:A1ªLÿ»òjG¶ÂÅ'1ñ7‡˚|&È¶oN©3˜•)Ò	qÁ6Ô•úzÛaã•kU=sÏÆçyÃ}≈≤a˛¸9Ã?X^/3√”ÖıçAycd¯ÜdÖö≥_â/€€HÄµ\jÑ√J∫√Î ",gæä∞°úÄÊlÀkàÀ,À≥≤7m£†£ó∞⁄!êÄÑ}Âµªp§.éˇSØ|î ô|+LÓœ˛NÁÃO˛&¥gø2;˚ã~2<ûÄ SM Û`π¥Ø_˝Ø=óìêêñﬂæ””#JA°>éèZÛ{Êtn1v£¨Íj;{Ò›/˝÷|d:òﬁ<°b¨BdCôŒ¯Äî∏Lû4‹ﬂPcËW·"‹ÎXÌÇeˆábx<¢59Ìπkêx¸d≠xéim∆ñ30¨ãπg€ém≥Ú∂8’%Îö$ﬂ˚ƒÚR`ø<CEÚ©Â8≥Ç&˘{`ß-’RÎy4"{êP›âÃÖ¿xàElô£ıë¥y+™ËØnoë˜ª0l nóøÃtoPôÚ'ÅN(÷ô|S]#4€.™Íÿ∏±,ÔŸ—} ∂å›M≈‹·¡Ú÷R#z¡ÀﬂîàﬂîàEïà±G”7¢l~ø3bD^◊‘zÄ“pVŒB∞ñÛg@N£åHıö∑°Ù”y¨¢Ò+P%*’gΩNøﬂΩ|’[Ik¯πµg‚≠ÛMyˆMyˆ•îg∫‰⁄˘W«gH®›»Q¥1ëÖD3πnÚ˘âE∑{1´Z4;x:÷^ó“;7Ÿ∞å≤E‰ZMƒbØ.	kΩ>Ì^¡*Oª=ûÓÍ≤su.#hjsÄ¨1€æhœ¶®-*y&}î◊¸à¨¯S$&ºíΩ£ ¢≠ﬂsÄˆ∑Î,äpÎl$«ÛaÑ7å÷IZÇº:ßÔ≤˛–…#.wq¸[cH˘ÓÂ$¢X!≠uîù£tú»»p?ím¬.åP‰eg´TÁNR$MÈ yF£[ë{å±]·PΩ!œ#XGí¸lEÏgA
hIÆL eŒ‹gÚ)3P¶2ÁJ'ß<H!••¢â $2.@Ìƒ%Hâw¢Üóº ç}¢(—~ÙÇ° 6±ÆU$(Óh;M˙‘)õíîÃÍôZ‰h«ñÀosy.ºÚß£îö#µ≠âJ§´1@Ñ%.é`&zŒ+GP∫€©}∫Óìs:ÏÕÌ${±ÉyGô◊Ú9ºpŸ„ƒ‰gujœºL£“áÆ»	≥t8tlzXŸ˚Ú⁄◊%@˙Õ^…7ùW›^ˇÊÊ◊ø∫∏x}ŸÌø!Ø˚AJ£G_ÃERí®*Ñò^◊ˆ|#`49®Êüñìˆ}]X¡eòìˇ`∆◊?∑“∆ô‰g5˝sÚSàé(|¿m∆¢ß»^&3ø_Ó#MY⁄g16Á.ô√e1Œ+‚GÚïòO∂–5¶£]ı yCNùÖm9∆(ﬂ!Wöh9»áZWH[°Jd 9‘Á©-ƒ6	¶Kì†àÏ(√/ÚÖ[¨üõıã
êÑ¥f3RT)îRGA"˜”z.a,#Mÿ~-È±5ı—o*ûã%	‹Àºi-Åê•3w…à~2á9Ï.õÊ#ÇøÙãî-kGñøõk64wÇÄ‹{L!äëâ∫J1-©Yº>k]Å‡õä2è‡Ì5@aÚØ‘ÑÈﬂËœA‡ñôΩ!1¥'^X˚∆P.oΩ€"∂çÏeTnjw√Á‹›P^&†Y¯ xîSîÚ'ÈÜ.ËËƒq>2s€Á∏¥dˇ)à˛$˘	⁄Ç˝∫	S˝8◊ßî‰øöõHÊÜı—ü¿Åå'ƒπÂ≈^s]ûΩ>%∑‘Á.}í´´/OFÓõ∫rÍ— ØrÊ:-KäVÀ[äÆ'.Ω=*Öı¥ãE’ƒ´cÏSVG˚˝˚Í,vA¨æˇ¬{ì£7˚Ø.˝õ5ø85GgŒ/*Êœ7‹1ıèJÔAV≤?™Zπ‘¬ÛÏ †æÌ‰•öó◊q·Ù¯i)¨:yDP„‘Xñ∞VäPÍ!¶≤âkπéõÀÿ{°Rí\áâp∞£U8¸(ÅŒ!ﬁ:r›°,ü^Gì˛FØI¥müë`≥˝∆®Àg
í˝“±,gA˛%C†'L’:¬∫H@π1-¬WA±•?i¨I±2Ó÷"Ÿ∆„»ÙÿÙ'Û£œSXæ9u˚√Ç3j4jªïâ·M∂«ÒV‚¸´≤øIVÚWßßØH|c~sà)l”l”ù9∞LáÂ©¯ï_¨åyD A‹!éwÑïoFŒpé^¢Ã¬ˇUœœƒÓ>äx*W+{íØèXQë≤3ˆñ Îe5∂ÂoåL5Á#tDΩ°«AÌÑºÈz§–ÇÖ$Ø!Bˆ'vI2(<HPA¸Ω ƒ —™ÔQx9˛-†à∂„„kŒdº|"πÇ1^≠-¿eËîá7Ãø¶=\§åç!…,m·ò–‹Q„JõöƒTÎ”2]≠`-&â0E^êçõŒ…’zßëÎ´ˇ˝_O;≠V´‰ üÙ˙≠õ~Ù;ÈΩÈı;j[ﬂz÷˝‚ƒœjOF[¡z§ÖE¶(¶¨ékÕQx*ÚY<u–ùc◊π3±˙á}k∫‹Ìr’lﬁƒY`'â>VEˇÚéÊZÔ˙nËÆ3ÁáéäÄ»@NmÔ7S~„”—:ﬁfz◊rı>&v2æ][wJÍŒ"ÏiXóóµñ:NÑ;[¨kE÷πL π.ÿK&ú 2…tÓ —r∏[ã*Ó<ﬂ⁄€«ˇ,á≥J!+qÃã”ÂLÉ„	ú˘“WÜ‹Åè;Óë÷ab˝¸…ÄNLHÑíÖ·⁄H(Õ!†Cˇy @Épôm‡˚aQi‡ı—ÿ/d•7~qg¸<[í§KtNK{„ál¬.Àò∑[»˝˚8)7Ë®íâ ÛÔ‚√ñE]øÔöÜç^fü˚«%¥HzäáYÂ¬€ó9à'ØÁ`∫97Ú€Zµﬁ§”w¨†° øÚ‰
.⁄^˜‚ıy´ﬂΩ∫|!ù∏¬O<õ/ñ%§•óSÖ øY1WŒêŒ_€ÁØ{0W“?ªÈ¥˙‰¥”Ô¥˚ùSÈ‘%yÏîéÏ∫Lá{ºŒm°Lá	ÿN˘ìáì $Å“≈∑@ [:s‚ÕÉ?ÜÌ¶3™ Ë=&òuÃxAﬁ†¯XñÉlËL·)ôπŒ.`/,N<,ôÁ„o@wÊ∂g|Çπ∞@gÇQ∫da"1†
^)áùöII∑tLåÙ¥ñd6w«Ñ±!∞›ãS]˚l§ïw‘ê~®´
⁄l◊7ßbÏ-µÒ∏yÓCY∏o¢uO¬iÌ√
	P$èKn≥øK±,}À€z=ÎD\CZ5=∆bU]æD‘ESb!6 F]§§;¡ÅBËπ¥D∞éﬁu˛⁄ÌK©Ö∆	 hçÉÆÏñîg"Ù\Ó‹ﬁÿ‘¯pôˇfn´Ω ≈ƒ±y}º¥h&oÄ–…¿¸◊Ω!ª∞[πä}πﬁ"A%“a
zÂ~k"˜YGÓsm o_]æÏﬁ\¨Ê+¶C|:)ÚåZ≥’” ÚóÒ›Uòø6°qgm°±ñEaÁW˜ôd∑∑•›ç¸∏•›nô,YpƒıbƒÖü@FmjdTk¨ïQõràƒ ¢gVn⁄ïÀ_\V Øê ≤…rŒ]&‡§√^ÂNNÜÔ∞†Û»Œ∞ú(ì·ÖÅ™iÀ_îT&"%Q*π|”îq(,84…B=J€«+í\˘)öà4z# M*oü’>Mﬁ
G‰¶¶eAπ:l-B«√›ëGå%JR§C∆ÇK;„h ·œäë'2ÎÃ,‹‡>à:¡ù¡Ûv¡iÔ(&¶ObXÈòINA‚bzËÕã‚+E`∫j”ÈRx»íT…èîŒ†°K>ôP√Ú'@¢]Ô;“Ω%F‘ıò˙|ıX˛bôa]sÄG7=«ﬁ,„‚jHaˇàsF0áéMó`&Ò™"OªR’ôŒ[R]qÌèCï¯âˇ<)d.&ˆéúöü[N<\_6›Ûı·Ûáñy¸ˇ„ﬂ¬Í«/Ò†ÒÜà êk†$péS¿J<û§®J^“∆¥Á®ÍxÏ‡˚=ˇª√mË∫‡®a'm◊§û0tﬂò!ú≈0ÖëéŒ¿ŒÒ»–]VW™’e¨P∂xF,…<Í¡È˘,æi≈íHaå–”Á§p8·õË1`Ñ⁄Å’SÕ,∑Á÷ä¶“' YYπ©µaV(‘ƒÅ∂=1ñ4à>Ü>¢LÜFı'∞π&íè€πMÄ•9Sv¯ﬂ…C-Óˆq√o…#38Pè¯'|7 †¨:Fx#ÃóÅ¬ÎéŸ€¿∆\èªÏ{⁄^Xn<Fπí	I™G1ÆƒŒˆæ[ç¢≠p{&"c”U$|ÀcM©‡nX°L(S⁄|8~Â¯Ä≠ﬂ}Mr+>≥≤@Üo˝÷E±∆Í¢X“ïÎÎ≥·5?üO◊µLÿ⁄‡¬÷∆S	[®óOÓ8»ÎIYL≥	Zµ-ˆ’ΩÕ≠§ïPå/dzö§©+`«ü◊F»è?Åxò üe§4&wl7ì˘™v„*Öÿ˚îŸêÁÌ™¡∂Ì40‰∫±v⁄0—∏dÜ«î!§•U,bpv2q1◊÷@X¢6â"èí{Pg∫Áë¸…ÿïœ“∆–Ω°ÕF]≈‘&wUQ/Ó…egÿéù¿ ÿΩSU[⁄ËÍ«=≈∞J„–º5álŒË(ÕÓ—ÆN»#=—U†<M.CÊnOeIãú7SàXÑŒÆ$ Î¬Ò…¡yP*·_)ÎXv˙ãJùÂN8B‚ÈHÉÑ¯iúπüsU∞J&WgS›Õ±©Ü.†—¶m≥L)nXµ	ˆ⁄Ùrá…8XTûñKƒôÈ  01E±ì&å\jL=∆•Çê€è—] ◊åM[≈©f«y˘ÿJ—`¢E:è0∆pANwâº=∑˜8∑…@c‡¸Q“˙,-+ô …—í`n2ÿ" l¬vUêõ∂ZŒåéLÉ-$0{<›¨„V±õ9∂1∫ÕÙë%'s`≥Ç VF∑ÄŸC·ıG∑.,k·∏ôä¬[⁄CT` 	A1¢u›%ü◊DÔJè∞ -f˝E[µÕ“2 UN≈©
;F0pÅpÕ!≥Zœ®o2⁄43pHXüß“xË‹+ûBÚõ«}AD-å˝¡=ì˝Uë?©êâ5/Ö1ÇdÈEs5z°”Ì(úuôÉt∏”Ú-≠[ö)-ãNò~0J~…7ôW˛U∫:c%Ñ__ÂëA'/÷∆0EÔe %Yi¬äëå™¯ÅWπ∆Ç£
QØˇ˘Z7°∑ú ) ®)òœùüL∫6ÉEG â“eòËg@ÿ‡7ñˆ˝7æÁéÁ%ıH`ÅÁ¸;qwîÜà•m`â_û=;äK˛ç/æG›OËIbé(yE·Ú1I´K⁄√8æ Æs∑dA}.÷z.À{à®îƒï≠Ë⁄tò4yc∏òÅZ”ô9¸≠ÔWêúúö∆ÿv‡RÖõôÀÒf·¢Ñ;Õe£1%üê˘	ò|2»*∞	9*€ÏÉÆ⁄]2Ûcì§ü¢Ì´‰A‘Ö§®ØÖÊvóÎ™K/ıÔrâ–…j¨ØIÖ˘ÚÆ≤∆¬G"gUº=Ñöß,Ò_–5É«@wíÄ—0ÜÊYìÖüƒêv3∑mŸ'úcÚ˘˚‹ÒçsêΩ|¨)0 ÃÖ^∑A∫HÑﬁ|8^=ﬁç--⁄!q5â˘áªñ?˘f˛‰õ©…7ãM>Ôy¿w	X¨V%Î%E9ˆJN ≥H◊ÌŒmaÌ	~Tg«2ª˙IôÁÀÊ,T*ôÅÅ5ŸFΩSa#&sÇ◊Á_ÃÏÅ¶5IC™Ÿ“∆Pt≈H—¢§œπv 1…£‡°¬ij]i„ÆÇoC¸N"è∑ã3€+G◊Tf6G@—Êv≈ßXp§‚©≤mPôã˚\§¨V´A·âÄN%u ô.ìîÆ¥yAˇdi6€¬‚\‚êpJóK@ÇàîTä•=y™y¨˘é$[Ï*∑V qF≤S˚ˇ˜Æ⁄?v˙‰∫{›9Ô^ÊWåñ›j≥.“∏ ØæƒjK√∞6M	·á5KﬁJJñ»ﬂFùbÙz‚ÊèÜWúcÔ5S˚–æ∫ºdÒ‰{h‘àRo•eÒááÕ8lÈ·CﬁdÉªóØBt9Ìˆ¢Qî»íwèÈª3†› ï…àGÔË˚sh˚Í’efHÁÚ’ZÿOä¡j¨Ùı›ÂãjP_’¯a˙ﬂÛ´vÎú\Ω|âòD⁄W7v∆Ø:›À.AÅ„Ây´wˆÌú•Ñ®sÛSÁÜ\t.Ænﬁ<Ÿ!Øu¥S:u‹Â5fØ=∆Ö~¯^lêz˛pqB∂â™ExZö0qu… £◊iøÿ¯Í˚(§îWóΩı`AºQ	!G”\Ñá§3˛	Œó≠°«éÏOŒªΩ3∏E.ØN?À©Îÿ%t19Ì∂^]^ı˙›v7∂wuﬁQTRÄˆeü˜èêë ¢8XΩn…Õ"ôüãÂ•I∂¢br⁄ƒRGï¯›s(òë9rÛW‰¬Y-V‘Wyô7åeÖ?◊ùØÃéØ¨áë‚B≠ŸÄ)√¶ÉU—mÚ‰`±ƒò¨¢ìæj˜v/˚ùÛÛÓ´Œe_ Qr~ıj›<2ZS:æèA˜:àÃ|¯„£2È(e~éo·(äRi¬ Õe∂¥DJßRœ¿û[^FÏ"®àü$FHrFÜm¯…¥GÊÿ·>˙‹fßÌ;™TêB*;ò:å≈œV?∫îV˙ä<ÛsgÏ°€.5¶+y®å≠áÓLu.≥ÊÜè∑gQù≥rŸr∆[@]GÙéyRÍT>+¿/HyˇG¨|œ˙Ä?`¥™7†AŸókXÎxÛ·É˛ïƒˇÓÄT4E]¬èÇ¸ﬂÂ‹¸SX∆?∏>”ZÛı •∑Ω◊Ìvß◊{W⁄îJ∞øÏˇ™]ˇ‹∫π˚ï8¸Ø—Î’èbü±U(-«é9=k¥L¯—Å)~PÙ=‰W	&¢ôIN¥º§=Æ]»l*‹Ì+eXIDfk≤v$=`UvòS”ÉQM ªµÔt‹(Nc˛¿ΩFlÊj—^)áF—¨Î˘ÅØ˙ÕñzAáN·“≈YuEBmçΩZ∫∞FS,¿µjZ.ëGT#ÔŒÓﬁ7"7◊˝≠˙ns´˛wçx∑KOÛÎqxgı©è˜ñn3˛¯ÄÁ∂ØÓœ:¸˙ù·øD’‰oEìµÉÁMÜqû∂dr`_\Ørr~@p¶^2“5MΩÂå|¡k≥~ﬁ‚…yº•ÄbºŒÈŸŸS≤pI,EïáÎ¿8∫tFê¸·Z@Ù^n
∞µÜ´‘d’eQ’%mÅ•t~åúrI;ª[çz}´±≥œã6ØêÔR^æY‚ª¥®Æu=˜s®V2Èsg¡ußØÖˆ5ñ€‹±Ëj∆‘m
Uÿ:ïñ3?.¥ÃÿêËäÇ”$/¶ÄÏwX<˘˜\˘¬0Ì†$2lLÀ•∆˙ÖêÖô»ã–ﬂ∑⁄Ly¸Ú“ …y¨Œn-p$ævÖ
À≤$Q|âﬁ ØRëÏ©äfátjÈlúDëLÜ©	I±ƒ¯ˇR>N~hŸP∏Ü ˇÎY&˚£¬¥k¨n©Œ¬R,Ô±æöú.«"G∂(1H3ké◊Vª+P+3õ ïdZLx˚ï0X˛/x∆§s71 ‰£¥vÎ™o%a#a|SòI*VÓO- Ÿ¢¡0¯¡ÿ £ª‹≠CIh8˘*ÒÜù2F#^¬ŒYÿpÎsSÒ˚÷u˜˝èù7@féÅµgæ÷0dÿœSjœIÜÒ≤dË¶õ‰á±ˇgﬁ|ËRü∑§,g∞‡p^bã"ÄúÔü2‰F{=ÜüÏ5˘ó4íjÖv˛ŒàiTï¥ˆf¨aÊØ∆éêΩ0Ø›¯∆í$ØW´¿tg~jzS”√ÿΩ¥j6VÁ¯§\≈V…˘†’´ÆKUY{-Vƒ 74	’µ)j≈ÇÏx„Ê’dgö$Æ2⁄kcŸbO>ÕÛÊ∞=kÿ√R
€ã∏Ø·ºÃ¶“q~≤îÛ<äùxª 65>´˘µz”úê¶t‹«•‰Ôjœ≠0t` r∫,£D™’«í˚W‹ïä	9”Ø´(æ¬wó)∏äîï‘ñN+6˜B≈¶»•( P!#ÂLJ		üY±¢Ñ kv'„h∑Lôà&®=#œŸà*“Ê˛–Lxñ‘rYãn_SÄl√2°üÉfØ+˘yÀ
ÑèP"A7E¬[`< lΩe,W®& Ô«ØáôRQxﬂx¥v+Nz!)∏¢∞˙Ö5ä®fı<E˙HâíP´QM›ERìddºÿM™&ìñ
TÊ™µ,j5¢;KõdFJû,ÀÅÀrWoÓÛcÃÍÉ~¯oyÁ_Îq–FòÁ0~#‰˜#¶ªûeΩdæª˜∫Èm0®>¡Øﬂ±'Ï˚π≥†0¬wô≤&üß^«KÀ1Xî5*Ì;póëKË3
˝:7·óû•YwÅ≤z/PVÔ!¸5≥ }ÓÓ.K’d b˙ºÒ«wd::@uwâ »Äº	ì´`£a¶#x”»ê3gvn¿ùùV‹≥æÁˆ∑Ù"µh»H∂—Ωùtdı‘˘ÂÊÎõÔJÈã˚ˆMﬂ¢Q◊Ik∑¨˝ÿr'c6¡˛–î∂eGŸ≈*G,«»ü”\4&êfKØ¢u'Ù Gé¶$K -ﬂ!rbˆUŸã3s%≤]#¿≤ç[ePï4◊ﬂgï”mÇ<◊≤}Ê√!pr+lDËQ°›å:pçÁ+ÌÜ‡≠ë∑#‚4rwÖq·+ÏJP{dÖ]IQX•z£ËûƒA9;O!o?ö¶Ã∂§—«•>ÊÂÃ^}∫4\ÅGﬂXs$„ó’nFÕZêTkK,ñ#Á∫5ÓFa*e5Ç#o?´\o;sz·í[≤ºªﬁO•‘ç¬ªˇƒÌÁíbJYŸ%vvoÒÎJÂ´ˆPAÚ\™…*†`zÂôK?·/¯ﬂÍ≠âe@a|lK2#+œ\¨#<2\PÏÅ=≥} ®ríŸ»ÒSƒNŸm'X'RQÑöA»Ã`eH∞µ†¶A_M·± &íÂAKB»2ÁÅelFßºSP‰ÑÇ◊√Sl’9*‰NÈ–q9tUuóë§}\Ã“,¢‹bÎ„¶≠l∏j¬@æèÎ PPv”æ‘@ã n≠µ/t_u·¿<¡Q±πm‡ÂVÿœ1”√6ñ¬˚W“x'ƒŸ‘∆u °:◊\†∫‡¶¨î!a@Nn±&¶5∏è±Ò:%®¬c:Ds5K¥Í⁄_%5∆º`âV9¥MS˜X,RBùù=∞¯5eQ¨äû5*ªîxá·¸´Qh
*ñ>íe´Ií$≈PÊN+ßî~È{ËöÃoAæ…´&„U{q§¯°òF(MUêñ`]‰ˆƒ∞,jèi‘∞_ÈÒÜ{-!‘¢¨[Xw4ô¢é√~/‡åÛxı—˝«\Ua5R'„·p∏Fb8	◊µ.∑W@AÖ¨¬≥ı√˚!œÊ˝ÑZÉ¥¢äÂz»2zO†≠ §ä¡ªJ3tU≥« ÌªÍ©(œlê/.À9j†Lço_]\üw˙ù“¶ˇ^êRÜŸÕJß{IIlß)ïNw0ÉmF˙îz†4bÍî#ä:íx¿HRDøò°xÄƒ#‡◊0‚]”î„Á'‡jˇS™◊jT¯‰	Ë∂V∂UyÓsˇ+"eH$õ á#Yû ¯j\3¸æ åø«t\ö¯çU?b@sUt"ëÖ
'Ul)¶ËbõWÀ¯‘ËÙÍ	â\e;ˇ$˚˛"£˘i‘“àøÀ—0Å–JÔÅdÊ"°∑3£Æ‘^rFVwóJãìCπ‘ÜÃ]LC†÷PÂ¥	´TÙ‹[¿j•Œ´Eºã$†W4%©*¸È¶¶7á‹7‡qV˘ÓO˘â¥Eﬂ!_≠äø\„¯KˇÔ˝∑%ß≠Ó˘`€N»’…È¿ıãNül˛„˛˜ˇ˚˛MhÔü¥˙‰˙ÊÍ’Mß◊S±k´√ß∑æg(sFŒØôTSÃ+∂Sáâì–•NÈÏ [hú?ˆUæ√Íj*a\z‡X˚&ºÙ¶j∑Ë∞ﬁ&‡≥^{°;gy∏ö6mxˆw•áÚ™G%˛XF‹
yN†ÓVNºoN©3˜oËm5(ùª	õwt ß≠\Ñq¯LΩIÍ™ò9\*âA]Iâ0„xùÃ≈ 5-«7òløQqT
˝…lA»zÑµî¥Ê∏1'z¥Yîgœ|¯W$Kz=!
¨$Db±Æ†˛:æ“„wfËhÂ©x"°r7O ˚z• ZûY@*U6vC±≤±Ø©s"Êäòèı{Pâ=Ÿu¢‰»‹·Ea®&∏¡» å°B!up~O±s3!ÄÉ€HTQCr∂C∆{a\⁄^ ◊5ü_*X®)?ΩÄäôë˝M«˙ËJàı	…C§t‚>Z·¶S:"N~BY≈ËÀîœ!úBN◊ €—É˙˜πÈ“Q‡'√2Wù„Áıˆ ßæmj—ÅªÆXL≈~Ä‘ÉØtÙUÊj=æöÕbU™“Â©≤V—ÙÌçN8‹;§@TeÔc≈·Áëä€¢Œí4eè∆íâ8Õò˘`)oQU`Xë †<4]`—ﬁ˛{æÊ≠¨ØAmoÛ}Ìè[Ç≠Ò˝≥⁄1¢]§Z—7&[Ê,$t,=„Uq±tßˆÎ"qΩ(˙~ÒR]Õl]‰ÿcc˝ »{
_\‘2&ÛeÀ”ZJjTQÛõ"æp˜
TÎÓÆÌ∏6föó‹zR5¶`dØcïÚr53|Ω†>Æ∞ö4¡KÆqÈD∫˙…ƒ ¶›â±0\Ù⁄fLÉ≈¸Ò
≠+yN:ä7£<ûÁÖQˇHqZ√…√ n‰1'¯O⁄«<è +fTW®ãd√kà§!ËoìwˆÄˆØáéà˚qË¬EÂ·Â»&ÃI4Û“LÓ\.OŒ?róê5∂ˆlã¨æmı'ﬂ6êX&¯Oj€ﬂè∑M‰‡◊‹µ¿éït¥eÎ„”€KÕ#Qî,Æ'zƒÑï™R&q‘‘‡¨`ÒëØ_mæ{ö¸@,!j6‰Bù-U5Ø∏úíÆÿ'VåhF%#‚≠.œÃj˜©§înØáââÉt`/_üØ&üH2*pÃPyÿPî_LAÖ2Ÿb(h˘h
Œë¥B]â<{ê"©Çƒm‚y:Úº6ÀVNÚ4¶d√‘∆ÖZsoùüGg)±1≈)WvüJó"Ò≥–m∏?^≤D#ño)…≤î+{+D0
A¨qUØıÎé6øÄÜ*’CÚÆ´√∏0&˛˙a
¸fJÅˇåCAÍÿcêU*T‘
´Y'∑µ¡Çﬂ[”≤ƒ*è:Üá‹¶qru˘ZìXx•Í:≈Ü∆Zce ıq™?˘R∏˜=π¸ç≤\aÈÕßX PñPΩL)MJÂIIÏqVÂ8/KÄ<{.Ø 
8ñQ®›ÒTEX
í¶»sPÓ”Êƒàú∫¬ƒ∏ÈåJqjñ=ïçI≤™0ÖÿZ& ¥WfÇ2ÀÃj3µ,/öWÃ“–nﬂtNª˝À÷ﬂæ:Ì¨dLE!__˝ÿ©‹ü¬HU€Yî7´æ”„	F7´ûeiπ≤∑˘∞2Î®}o>`–∑›vlêÔ|ûj@NËs+èÜâ
‘†∆ÂÓ©Õﬂ``¥è… áÃ’–≈⁄°ã)‡U8ôH:xyµ†ﬁU–rn¡‹'Jæñ33ù>À%Å`ÇïÿKAT¶<1à®6úåX±RÊ˛cvg¿$K‡—¶.ö±†ßD∏9WG∂"´,Á;#côÕL¡D.%%¯Vπè‚ÂF¸RP™\y=Í˜§∫—úHq¨A©vˆÇı™ﬁ–@∑`2©ˇÃ r2,oX ~Ä[`!Â˜õ‰^.BÂKV·æaÖVÊ6(3Yæò¨ßrgjxæ±®2™"531ÁÚxÒÜ\bépöT <ﬂóJÜU<=[˚º’Ω '≠”W¿}˛@XÍ()=˙UìpÜèXà*VÓ1Jóƒ9bqÓŒl… H“p∆-ŸCad”√|º&ôòqV+ƒ«£∫¸¥Èå0'œkDL® ùM:„Bﬁ|243bi0Y’Ó¬<èJ∂……|LnËÃq•ª»ﬁQOô=.2◊®°$ëéÈù„!baÏ3˙"]»·ı¬Ëb˘hÀRO⁄ﬁE±mﬁäê¯“¯‰∏ò’Å\∂1¶STï˛d¿]&€«®5k°ûy‘Æ¸≥oH∂¯6ltt˝)>˜· µhÿF(äﬂìSË±ºkÿSTåïm πí+&®ﬁ£Ü;úF"ÕHuäQ8'ÜÏÃœ¶?âz7∞é8Qça,”óå¥EÿlëçÎ2}›LÄ±hﬂ@{LÀ“f´¡hxÈ›ÛˇJÄ(A9∑{sê”m/†vá€◊u‹|Ñ#¸¶Ûá?¸   ˇˇ ÃﬁÉ
...
import { DailyScanModal } from './components/DailyScanModal';
...
<div className="flex gap-2 mb-4 items-center">
        ...
        <AnimatePresence>
          <DailyScanModal
            isOpen={isDailyScanOpen}
            onClose={() => setIsDailyScanOpen(false)}
            dailyPokemon={dailyPokemon}
            dailyFemalePokemon={dailyFemalePokemon}
            dailyGender={dailyGender}
            setDailyGender={setDailyGender}
            isShiny={isShiny}
            setIsShiny={setIsShiny}
            todayStr={today}
            onViewSpecimen={(name) => handlePokemonClick(name)}
            playHaptic={playHaptic}
          />
        </AnimatePresence>

        {/* Theological Exam Fullscreen Modal */}
 xúÏ}€r€Hñ‡{Eö—Uí&Dä§DYVK™ë(⁄Êñ$™E∫™ºá$S$⁄ ¿@Q¥F0/;/±˚≤œ˚˚>2?∞˚	{N&.ô@&.¥\Âö6ªK&ÅD"Û‰…sÀs!Ñ}éNmsf¯Ù⁄•µGÙ‰O$˙<òﬁπaZ´ø.ÃOΩ9µ…˜ﬂìM·><=s|”±kcÛN∫N»G∫:ÆåÒÈÍﬂ·ÒÍÃV%—»¥Mﬂ4¨„á‚ÃçëÈØIù<>&ö|àR≥F∫Ω7˝ºÆ|◊∞=«å-˝’úíä7wM{RŸ&cc6áoá§Ÿ⁄&ûoﬁﬁ⁄‘Ûß¢´ëexﬁï1£«ï[Ûûéa6ı´uB>Uﬂ5Îı˜‰÷¢˜ÏOu‰Xd8©zL£˙¢Uﬂyq@Ü∆Ë„ÿuÊ’°µp´Õ{ã8w‘Ωµúeujé«‘ñ°uíx˝√Œ?ë”Ÿ–§∂O^¡C˘ßù‰è`]ƒqCœ±>%>º∂N,zÎW;{dY}±O¶¯9ZvµUØÔ4Íƒuˆòé´∑&Ä„‹ÖqŒ”ˆ©[•wrØj;6≠êù‰ µ/:æÔÃ‡˝Æ9ô*@g‘5¨ÒzcP@i‡Ã…kjå©KŒ∑ òº)‡√G‡–q·©Í0¸Åf∑.,'¸~Q'Û˚ÍÒfáÔôØ™ª|˘MüŒºÍà‚`…ﬂàT´Íê˙K
˚ibÃ°›ßj≥Nº©1Üï∑&ï$”„KwÃ:R<ô~v	£õ¬0“e†ˇN´îÔ-	ö!$Ï¡ÿ˙	?ÉIΩ´®h¥Ê˜‹…–ÿ‹ﬂn4∑õçÊvΩ∂ªıûÑ‡VéfpÊ¶›6›—¬ÙÂ©Ï¡Tˆ¯TZ|&-‚”{?eH:™ÛÖÂ©êîΩ``Tvj∏7˘∑ù•kÃ…r
<†@4∏¢õ’¥)uÌÿ~u∫ˆehm‡3≈©±∞8ÒÙvazã˘ú∫#lÑmÙhWuié©Á√ﬁ6∆¯7F·A2x›È›º%ù_N/’√ﬁô65Ç˛mqJ∞ö∏ÍµVb¯≈Ë†øÛˆÍâπ≤_Ôı˘˝˚ ÿÃ±ù té5Nœ7ƒDo¶ù˘Éjï$·¨qr%p'∏úæ>\ Ì≥â¢'«n[ÊË„Ò√Ê9>!òIWÊøõ∑`Ò÷_àá‡Ùjﬁ»∞7·Á‹2VØçπoé67,§©pÒÒQıq}`y8Ω⁄≠±›k’L–N·8Öõ":åÆ>◊Ñˇƒ%‚-ÿE∂âµûãÿp’ å-\œq´MW–‹gçZ∞π√Eè∑Æπf+¿≥0%br£ èo˙Ä¶m9–œf«m•[)—‡aboÆr†∏éœôÖ8wˆı÷qgdºpv	ôJn0.%‡ ô∂eˇ;i_Ù˙≤Ìp‰KÒi%Æ™h_µã(´™±X9yπ7rÀwu gÊ'\Çe Û¡™˚d6Ü»Ã∏Øò Àf˜ºß%'íÃ§‚Ö◊ŒGÍOÀô∞}Ò≥9ûP_!}§7Ê—N,≠äw∂‚M¥ìá£{©°†lqf¯Ä1‰ÜzÀ'ó(‰J∆o¿Ô˜G.p}°”√m}¸0dç˙à!‰¯¯òl‹ÇdÏMÈxC§GC°´˛Kl5¯ÃPºæ§{ËÕÁ¿Ï®èw∫ÂÖ3	¡WÒæøpÌ´≈lH›„á¯ªbØØ£ëºæÔ;¡[±A¸]—√•q/t¬~©˙	öI?Ω!ê^‘ˇ©Í/l(ˇ~îVÔâ-,:®&¬±ÕÃÙ<@π+@º¥Ç˝‰så∏oHÔ∑o(`‡hq	Ò“aåÎ'9¿îw+‡ Úc»LÿõaGÜ|$Ÿ‚,F√Õ¯Ωò+∫ò3Í,¸M’‡q6Ôe3Ò‰„6i‘Î“≈Gy⁄]€õ”ëØô6åüﬂáÒáªÈª≈4N°—√Õç±·ä9öhº§;;HÄù∫‘6«ïdá◊·6ÿq9˝‚^¥6%lN∑ºëx”˙©Ô-≥Q–—KòÌ»éA¬æÚ⁄]:RﬂˇM®∑˘@ î¿ïA'-õﬁRPïŸ˜\S”∞™¸˛Ü|1h…Ø¬E:fﬂËùÅ{á}7F <#ÆÌgœ˛˜ÀYHH7ﬂΩœB¶“ù~]—%èz![Û˚Êla1qcS◊’NöÒ=¨¸”≈ÿtﬁ∏ñlb¢ÇÁØ,f°õé¯êT∏N˛¯(ôîn®1Úk¿aÔu,Pıa≥kgà·ÅŒ∂⁄N{·Zá$~ˇ∂t_«¨6À÷Â¬3Gm«∂ÅX–1u≈:á&ÚswéµòQÏ˜'ˆMæk9Œ¸ê ÖëØÉPÈOavıä|}Jqmÿ§íp!p=∫ÅÇDü˙H⁄<ïëa¢;Í›ﬁ¢ÏwiÿÄ‹.òŸﬁ~£:„w\$r¿ø“ìxıë)! ˙Ü∏√®`∫]∞Ì±9∂è¯z¸†-w%ÇóÖ”[ÀåË3"~3"5"ŒÓ‹¢ﬂlà∫Ò˝ÉŸ#Ú∫¶˝–É-kÂ,+1ß„˜Ä
ú ˚!Ÿh‘Ω4Ω|C„W`J‘öœ˙ù¡†{ı™_ j¯•≠g"◊˘f<˚f<˚≠ågL†cˆ/chQ¬®èˆÃØ
∞éœ2µÌ)mÕC√ëñbs3•nÚ=˘…Ù∞ábQ5=)ì^≥å@ÕjíÎ$Z˝µî-"◊z"6¥h=Vv˙Êº€ÉYûw˚◊ßoIªw5∏È]®ö˛8@’òÅ/ÇŸ≠EœúÅt¢6B†¶†Åÿ1ô ı© å£í;Úa¯¿æªŒ≤à$°c2ôÔ‡´0ÏÄ√†`®eÍuéòQ¥“¬Çä‘ã≠ƒWN∫¯˛[cD9ÙÙÀ§ÅàiÏPI “Ä`ïì`E∆Ü˚ëÏ∆0Bïó≠m÷Kµ¸?÷Ä8ï—ÿÇE∆Ö`_ö-j/Zi≠"¸D\qjÿcx°¬'†{BÄáK—FpGaª6ê$?Où‚EöàéUÌH0≈qqÅî:üÈßÏÄRÊa*Ê¢f"ËA5M%ëI∫ŸKZ‚˝°h·%?êÊQ™ÉÒ'[1tAãEq7≥”xIFˆ¶∂!≤f÷ (‘¢D+-[ÆºÕıπêÂœ∆	3G¨Ä*Äû†ÿ/Ó@ë
¿Æ·LtüI:Íı∆œñ,:d`∆qLG˝Ö-ãª î]$Ω0¢£K«Q›ñœÖ
¢äÓXI—B-C&•$a‰7tbzæªûı∆7-@;˙üå%ﬂt^u˚Éõ∑0√vÔÚÚÕUwñºt/∫ÉnÁÛs.Xö5ïHƒ‡oz]€Ûç@¿K¥Ñ∑!Ï:“~êEí*O∆6Â‰?Òıœß…√˘SŒ˛,
—1Ö~õîE¯ô±Ë)≤/ËP¸"Á/˜ëV‘\∂9à:ZBë‚∫N ÀÚHæ¢Ÿ⁄z_àçe—ÆÇv -ZΩú;K€rå±“ÿ⁄•‰]*j[ˇ™çÜF€
M"C ‰HÁSï9#YlÃîÉ^í$(";úΩ}ÇD î•‹R¯EõÑúŒÁd∂ V∂©»Å4¨
¡2≤Ñ‘eè≠ôè~SÒpÆùèˇ˛ø∑tÆ≠Äêï≥p…òﬁô£qóS/πù1I’¥vh%X62xÇ∞π˜ôA∞M°çp„Í˝≈2ë( d∆‰3ïÖ|.ÈHØ/€g0Ä¬‰_k	À~b∞ ÖDfˆÑ‚†]z`mé°ùﬁz‹">ŸOô‹ÙÓÜ/∏ªaö_å§ À¯,%¶(ÂóÈF ù9ŒGv‹ˆ%∏@&Ÿ
¢ˇí|â∂Üh_ÄöÆKÙ#kÇö‰øZòHÊñÜı—ü¬ÇL¶ƒπ%#Ë√u,d·◊oŒ…-5¸ÖKΩºaf“ÙÏõ%…}KEÓÛO2ê ëW;Ú,+KÇV´[öÆß.Ω=ÆL}ÓÓÏ,óÀöâ¨c‚≥⁄»ôÌ|¯Põ«.àµ~0'ﬁÙ¯Ìﬂ˛´Kˇf-.œ«≠ÒkÁìN¯ÛwB˝„ –ïÏè∫V.µé+∂„ `Î€åâ∫Æ^§L0â?-Ö8åÒ∏∏Í;Uó‹∫Œ,<jE˙
TÙŒ4™s$.¡oh”ﬂà J÷r7Wâ˜¨„‡T"◊Ï∆Ô®åÑ>˜€Ô,r›±,ü^GÉ˛FØI∂/H∞ºÅäÌ<◊êÏóée9KÚœ)⁄ =π0π1 4Rn6ÚWA±ïﬂiÆI±2Ô÷"Ÿ∆ÁëÈâÈOCFüg0}sÊˆ'√Ç5j6Î{’©·Mw«Òˇ¨ƒ˘weQÚwßßØJ|~sà)ÄÈ5ÄÈÜŒò¶„Æ~?¡∑s?GâƒQêx«hÊÿ-–KîùƒÛâªüE<µ≥U›…∑Gî¥F$Œ˚+6ÎL◊p}ıc”CÀ˘QoË–q–:°n∫)tÅ`!…k
Ñê]„ƒN&É¬â
‚ıÇDê∏ÕÍ0Öá„kE¥sñ†„Â…áÒzkN#ÀXpt√¸k⁄£e‚∞1$ôïm",wTD«∏ ñ∆·çuæ6-cáIÎÏ$ß»d„¶s÷Î°wπÓ˝¯Ôˇzﬁ˘•V´mêCº”úﬁ¢Î§ˇ∂?Ë\nËœ˙÷;›/N\p≠ˆU¥o¨GZXdäf»˙∏÷Éßr∂Ot'ƒÿuÓM]©nMóª]ñtï¶Œ;ë˙(·ã˛€;ögzá7ˆBÔ¨„¸–Q62P@∂ßvZ	øÒŸxo≥l◊r=%H∆‹•πMRJw¶¡÷ZÈ8B∂X◊åEwÏê54IÇÙ™Ñ_ÓfÁÕíÓ˜“…·^=<9lÓæÿﬁ?¿ˇ'áÛj!´pÃ#ë/Œ,Xû¿ô/…2‘|‹qèúé'v–œüÈ‘¥ÅO)YÆçÑ“¡v(‚?† h. 3 ﬁ≥ÀjŸGs/d»Zo¸‚Œ¯yv⁄•]rNKz„ábp˛˘]ÔlÏSê0î“D`£ífZÄùZ‘ıÆiÿËe¶πˇºÑ≤ß8 g˜e‚2{Üõ√ëﬂ’kçùΩG)HÎ_y÷F€Ô^æπ8t{W?(ÆÒüßáÈ	™(t˛Õö±r)Ät~i_ºÈ√X…‡ıMÁt@Œ;ÉN{–9W}^¬ë=ÅQI’©µËKÆÆ;ºÎ‹N¯ìáì°ÆÖ4yÉó;U9˘SP¿VŒÇxã‡À“∞}ÿÈå™2z¡CèâÅëÆ?ê∑x r¨ãŒ#gw…‹u&¿Ä=åàdTÜÔx>^∫≥∞=„∆¬ù	FÈí•âƒÄjd%	=:3eM∑r_fFzZ+2_∏
 ÿƒÓ@ƒ©≠Ω6◊¸É‰≈~¿âä”è2‘™Çg∂ÎßbÏ-µqπ1⁄±U·æRÎæB& <÷hÄ"y\Ò3˚{âUÈ[ﬁ5i'2∏·*_akvÑu—“ÑXàç“Q	Ìécp`z—*Æ£qz◊˘•;PRãW¿'@†5§≤[≤9±áÁ¢pˆ∆VÜ◊˘o∂ﬁ´ÏëPxqn/-ö  tÚ8ˇ5bo(.Ï’E©‚@m∑êà°B;L`Ø⁄oMî>(}Æç‰Ìﬁ’ÀÓÕey4◊®è:O⁄ß”"_Sk^Vq4y&äœñ`˛⁄î∆›µï∆zBiïùﬂMi<`ö›˛v&D2Ù«ÌLp´t…Ço\/F∑Ë®≠’ödÍ®-µé
D¢¥Íô÷õˆ‘˙◊ïV&Ìπñäb≤ZrW)8…∞WµÇ£?4DÏ …k–ùúhì·ÖÅ™…ìø(©LDJ¢T
j˝¶•íPX$p2híÖzTvNJí\ı*ñà‰ˆFöVﬂ=ØﬂMﬂ
G‰GM´ÇzuÿZÑéãª´éã‘ƒÒó¿¥Sé¶ˇ¨xÛD«:s< U'‡<o¨ˆÆf`YÍ©F´ú0Õ)HºCLΩyQΩBs
”ëµÈl%‹d…j‰GJÁ–Ü–ÔL©a˘S —Æ˜åtoâu=°æ?=ñˇáXÊGò◊¬‰ƒ∑õûco√.„ÍZH~ƒÜ1#öC«¶KlòVM©ﬂfòæ–zÛ¢ßY8TâØ¯œS–RAÁbjÔÿ˘!c¡VÅÁ◊†{~v¯¸ëeû¸«ˇ¯7–~}◊±''/q°ëCÄ˛ Øêk†$∞é3ÿï∏6<IQçº4<§ç·j/–‘:ƒ! ˜{˛≥£Ë∫‡[√N⁄ÆI=·’céx„F:Z8
@;–«##wU+Û™”.≈Ä≤≈Øaƒíl¿≠>¨ûœ‚õ6P-âÏ∆=›q,@
GSÿCF®ò=Õ≈—Œ¬*yT˙(xπ=Œ∆iM§mOá%¢üCüU&E£S Æâ‰„vai∆Œå-˛3u®Â—–›9©b¯-ô¿À»‘#˛“	ü(méû¬„e®p√ü∫Ñeˆ6pÅ1◊„^Ä˚^f/,7#ç‹»Ñ$’£ò◊bg{œ Q¥‹Säåï§PS5rÀÁxRÚÃÎ¢çóy£m–›Èxckõ`.ﬁÉ ÷„…+«á›˙Ïk“À∫ˆ≠S^!√ß˛Ë™X≥º*&ªr}}gx≠/wÜó’µJŸ⁄‡ ÷∆S)[hóó!∫ƒzZ≥ƒÏGäV}õ˝Ø∂øµ-üäÒÖÃN#u‚¯ã˙ÂÒ'PœÇ#»Á)-çÈ;-9_’^=:ñ,$ﬁ'éyﬁÆ:Äm∑â!◊Õµ”Üâè+vò8àm©Ãâ¨ùJ]Ã=k‚	XtR˚	3bï…≤E≤2›ÛH~9ˆGÁsÉ¥1toh≥∑ñ9jSª™hÉ˜’∫3Äc78lÅﬁd@pAW?Ó)F˙òcÛ÷±1££4„,¢]üêGπ¢e∞<I.C·n_wí9o&6b:[JŒ
«/§Áa©:ÑøT÷±Ùó’Àù Ï„hœ∆õ?ßCg·KaÆ^+‰fù©ÓÂú©Ü.†—¶m≥L	iXIº6}¿‹ëã∆”‡‰“uf6å2LÃPÌ§∞∆.5fìRA…ctË5”÷I™Èwã≤||J—d™E2è∆¿ gÜªBŸûü˜8∑r†1H˛®ié|ññïLÅdÉj…0?2ÿ&†l∏™HÜAL[ç,gN«¶¡&{<›¨„÷»9ıÃâç—m¶è"9YXÄõUÏò ≤2∫¬*h?∫uaZK«˝»Lﬁ °H™ß◊]rg∏&zWzÑi±”_<´∂YZ‹CU&AÑCÒA´¬é\ê\sƒN≠Á‘7mö¯Jòüß≥xdπW<Ö1‰ø˜µÓ¯@LˆÀn~Ÿ [^
Ôí¶≠rÙ"À∂£q÷e“!§’ m ”WpY”gâ˝‚‰ó»åáüñù=b©¿+êK£<2Ë‰‡≈÷∂E—{P…@Qö∞b$£*æ'ù{cDÀXÚ≠¬ﬂòmˇ˘ZÅ–_Õ`À) óh)XÃ	(ùw&]
¿`—@"ÅtCfÅ˙6∏∆“æˇ¡¡p·xPRè¥xŒø3«p«IåXŸ@úGAˆÏ(.˘>˘>uÔ–ìƒSÚäÛ1…ió¥ßÜ?t|\Á~≈Ç˙Ä][UêÚ(p17%1|e;b{Åì>O3–j:7GtxI¡…πiLlò*pfÆkƒ¿¬Iˇ<èÀ∆JÓP¯	Ñ|2Ã* Ñìm˙F	VªGÊ~|$È'h{ô<àY!)z∂P‡xÉÒrU2ƒL¶^íó+îæHWc}M´Ãó∑T»âúUë{D˙?O∏Z∫f¯ÿN$chû∑X¯Iåi7€Êëq¬9¶íø/ﬂ∏ ›À«öS†ÃºQËu$°ãTË≠«ìÚÒnljÑƒŸH„°ñ?¯V˛‡[â¡∑ä>Ô~ w	ªXá¨Z—KπÂÿ#9)œ"[∑ª∞Ö¥ßtÙQüELKAı)í(2œ/ñÕY®T$2)BkäçŸNÖqåò 	>;ˇb
≠IÎ–Ãñ<EWå-í}Œ3_ &y<T8Mm>m‹ïAmàüëBxª8≥ΩˆÌ⁄PjÄ“(⁄¬Æ˙éTA=’ˆìT¶‹≈ÆR÷j5∂A·é∞ù*˙@≤¨LR˙…¬˛… l∂Ö’π ƒArJWk@Çä$≈íû<íiEkæ´»[Ük%gÑ ;Ωˇø◊˛±3 ◊›ÎŒE˜Jõˇ[˜N∆Ù«∫H3Ä,=^}â9‘VFamö
‚kñºUî,=T?ç6≈ËqâÛéGCó±c2Üˆkªwu≈‚»ü°Pk J]‰Jønä∑~≈◊VÕl–a˜ÍU∏]Œª˝Ë-⁄Õí««≤ªS®›$
ï àGÔd#ˆóF–vÔ’UfHÁÍ’ZÿOä·jÆı›’µ†æöÒ√ÙøΩˆÈÈΩ|â;â¥{7∂∆Ø:ó›´.AÖ„Â≈iˇı∑uV¢ŒÕOùrŸπÏ›º}≤E^kigtÊ∏´◊‘òøÒò˙Îü≈â˚èógdáËZ@¶µ†	#Ω+Ü˝N˚‡∆74–Û£êRˆÆ˙Î·Ç»Q>B"éGs)\n>íSÒO∞æl}∂‰`v—Ìø.r’;ˇ"´û%.°ã…y˜Ù’UØ?Ë∂˚ÿ~Ô¢£©§ Ì7Urﬁø¸*äÉ’ÄKn…¸\,/ΩËH≤ìÀLØtTâü≠07ÄÇô#7}An!ú’bE}’ëó…p√HQ÷¯Cp€yiqº¥F]à]¥ÊCfõKö8¢€‚…¡bçQÆ¢ìdµlvØùããÓ´Œ’@@Qr—{µn≠©ú<ƒ®{Df>~˜Yôt¥:?ﬂo·[4•“Ñó§,óÈ“	õJ#ÖG∏ny±ãlE¸»;BëÎ0:ÿÜK¶=6'˜—Ágvô}Gu√Ç
í@HUÛk÷é≈œV?Y)≠2Ë+~pÕ/úâánª‘òïZÚ–€›ô\gÕ-.º>#é¢63Êõõñ3ŸÍ:¶˜Ãì2À‰S?xA á_Òç’??∞˛·º≠Ê-Üx†lO6ÎXÎxÎÒ◊Ïu‘ˇ˚CRÕ(Í~4‰ˇ>ákOa{ˇ‡¸L{d-∆‘€¨ºÎøi∑;˝˛˚ ñRÉç‰ˇÀv˝ÛÈÕïÿØ¬·ç^{?ä}∆T°∂;F‰Ùúae¬Oö‚%ªá¸j"¡@2Fíì-Ô û◊.dg*‹Ì+q∞"EfgdÌê=`uÁ0Á¶o5ÌŒÙæ”q£8ç˘#˜±}´	DªTç¢Y÷Û/˙Õ¶zAáN· ≈QuEõBmç˝z≤∞FK,¿U6-ó(#jÉë˜Ê˜öëõÎ¡vcØµ›xéÅÜ{üçx∑+WÛÎqxgı©è˜S0‹fÚÒ!œm5)Ôœ:¸˙ù·ã™…ﬂä&gæ<Øh2ºÁiK&ÁãÎUNŒN’KF∫ñQo9•_⁄¨_∂xrûl)l1^ÁÙêÏÓkE8yç£ √]:ßh˛¿p{Ø∂	
ªµÜ´µ§ÕeQ’•ÃK…¸9Âív˜∂õç∆vs˜Äm.ëÔR]æY·ª¥Ëÿz∂Ùs§72eÁŒvó]Ì	j,∑πcQoŒÃmSÿ:ïñSóZfbHƒÄ¢‡4≈É	$˚,û¸è\˘“0Ì†$2 Ê‘•∆˙ÖêÖ©»ã–ﬂ∑÷Jx¸ÚI„dã<Vg∑äWp)‡kO®∞¨
AR≈ód»ÎL$˚∫bÑi«°,≥t:N¢H&√D¯Ñ¢XbÃA√oB «ŸûO∂nA ¿=Àd_™Ã∫∆Íñfù∞À{ú]M.+«"ﬂlQbêV˙8>≥⁄]ÅZôÈ‘PÆ"”¢‰ÌW¡`˘ø‚ìŒ˝‘ îè“⁄≠kæUÑçÑÒMa&©ÿ∏?≥ eã√‡cK \tåÓr∑6%°·‡k<ƒ eå«ºÑù≥¥ÅÎú£‚ß◊›?vﬁô9—û˘Z√ÕP`óg‘^êMD&Àíë√3ònëÔ'˛_xÛëK}ﬁ6Âp5á	á„≤p∑h»9¸¥!7ôÏ1¸§Ÿ‰_ìõ4SiÁaçòEEZ(˘¥7uÍfÆaÒjl	Y–Û⁄ç9ñ"yΩﬁñµÊÁ¶73=å›ª¡s¡¿f9>e"ÆTj9®|’u•)k?e≈ä‡fFBıÃµbAv‰∏y5Ÿô%â€AÉåˆô±l±'_∆Û∆à=kúá%∂%ã∏Ø·ºÃÜ2 u~∫RÛ<ä-º]
õ>´˘µŸGsBzò … ßêø;¥û[aË¿åÂtYEâTküKÓs\qK&j°?´¢p¯á.3p)+ôYN8iÿ‹õ¢î¢¡¿lÜåîS÷$üY±¢ÑŒkv7Âh∑Lôà7LP{Fù≥M§≠ÉmP†ôÚ¨®Â≤›æ¶† ŸÜe~¢_Çfóçï¸≤e¬[®ë†õ"·-0•†∑åUâj|¸¯3Ãîä ˚∆ga∑„§äÇ+öSø0£F”lˆû"}§¬HòiQM"Âëdtx±'õ&Âì
4ÊÍ≠,¡÷jF<Kõ§ﬁ$Ø,ÀÅÀrWoÓÛÃ⁄É~¯µàºÛüç8h#Ãs? ˚ë–›Hã^*ﬂ›á¨·m0¨>√üœXÅˆ˚¬YRx√≥TYì/SØ„•Â, ï‡e‰
˙åBø.L∏"Ì≥§(¬.0VÔ∆Í}ƒøV⁄∏œ››UiA¢ö@L_4ø{Of„C4wWX@ †Ëõ0∏*Ü0f2Ç7π˘rÓÃ/‡ŸI¡Î+p>`ﬂïå‘¢° ŸF˜vrÿë∂SÁóõolΩØ$'ˆÌõæE£ÆÂ”nU˚âÂ,œ&l¬˘CKŸñ-e´D≥#IJ—ò@öMΩÜß;°8J4Ui5Ñt»tŸãSc%*(Ñ`È∆¢™äÜ‚¸¨R`≤MêÁZo1Å$W°GE&0à 4_îÇÜ‡≠ëqπPaRx	®µGJ@Eí£
àJçfQòƒA9âáê…“îKr˚∏‘«ºúi÷óïÜ+H‚Ä5«*yYÔf‘™Iµ∂≈b9j©;√›(L•¨B£D‡ÈÁı/œ>;sz·îÑ≥duwºü*	é¬ª
ˇƒùäbJi›5v∆∑8ª“9≈jÇ˝Ñ≠†∏Ø¥ã§P1ΩÕπKÔ
˛[ª5—a”«à>LéqIÂb§Âôãu‰ÇGF´!™= ì	ÉAììÍå?EŒ…£s€)÷â‘°f27X,A-òi–WS∏≠;IÀ†!dôÀ¿*1#åSﬁ≠*rB¡Î·i@uÅπs:r\é]]›%ÕÅà|>.Êi1n±˘Ò£≠t∏™t@~ÄÛ0PPv”æƒãñ’Ωû÷¬_Ë,&æ˙¬Åyä£∏mêÂJ¿s¬Ïp¡Ka¯U2º‚Ï˙√} °>◊\`∫‡GYâ3È YqFLk¿è±Ò:%ò¬c:Ds-K¥Ê¡∂øJjLx¡íL„–z4Mﬂc±H	}vˆ‡ƒØ•äb’Ùúa≤KÔ≤˝3öÖÇäï∑TYƒÍä$I1ñπ3√ )%Öü √@˚π&Û[Pπl2^ΩGbÅãYÑíTi	÷EnOÀ¢ˆÑ∆A’>o‡kíRã∫na€—t1å:˚ΩÑˇxœÁõèVË?.IUÖÕHyrúJÜ√◊5•◊)§Æu∏˝*ˆŸY?|9eÜ0øË',XZíÜ*ñÎ!-Ë=Åµ*ï*6Ô´≠–UMÃ´>˜ÿ”áOEyfÉ|qi…1Àﬂ¯vÔÚ˙¢3ËT∂˚ÔRI	ªiÌt_÷ƒv[JÌt3ÿ¶¥O≈Kµ/çÑ:ÌEI¸¬»Rƒæ;?⁄‚¡&ÉºÜ∏—u1M9~~¬^‚*çz˝;çOû∞=√÷⁄∂:è¿ÉbÓEt°¥i∞…¶ ·®Uñ'@>¸Ñ◊îº/‡ìÔ1WF¸∆°Æ1†ãπøj:QËBäìj@ä)∫Í)üö,ªz@B"G‰üÓ?§,?Õzr„ÔÒm(mh≠˜ÄúπHË-‹ôQWz/µ õ≈KïÜ…©±\yÜÃ]LC†!,÷HÁ¥≥‘Ù‹_¬lïŒ´Eºã®W4E6ï˛t3”Œ°ˆ¯<´|˜ß¸D⁄¢ÔäêØV'_Æ±¸ïˇ˜ø˛€øíÛ”Ó≈[€ŒHÔÏøtx‡˙eg¿l˛„˛˜ˇ˚˛Mhœüù»ıMÔ’Mßﬂ◊±gVáOÇTæÁ®sFŒØ©TSÃ+>ß'°Kù÷Ÿï∑»p˛8–˘Î´¡ÎîqÂÇcÌõ¿Û“õÈ›¢√zõ∞ß`ô≥≠YÎ¨WÀLûæÆıê@Yı∏¬o´à[!œ	¥}√¬ÅÃu˛Ω≠•s∑ à¿£É9m’*,®√Øı@“W≈Ãë
–H$u…a ÒZŒ≈5©«Lo4FWB2[P≤>√ÅZIZs‹òÂKü}, ≥Á>¸Å+	í%ΩôèqîR"±XW–üÌÒô:⁄Dy*ûH©‹À”Úæ^≠≤ûw,†‘*õ{°ZŸ<»®s*Ê>™òüÎ˜†S{“%ÍDÕëπ√ã P]pÉëï©É
ç÷Y¿˘=!ŒÕÖ ~F¢ãRã*Ÿ„“ˆæÆ˘ÚR¡BM˘Èt¬å¢Ëo2÷'ª†dÅXüê<DF'æ√«%8ù÷q&»⁄*Ê@_f|·⁄∞∫˛#Ÿân‹–ø/LóéÉ?ñYvå_÷€+ü˙∂©EáÓ∫`1˝˚R;
~“q¯¢Ø:07”„´’*V•*Yû*}*ö‰ﬁËÑ√ΩC™FUG1´_è¸P‹>uñ§)}h¨hëà”‘1LÂö
+2léLD¥ÜˇÅœy;ÌkPﬂﬂ˙Pˇn[8k¸º˛F¥ãT+˙Â¡¿dŒRA«í#.[àã1–›˙oXπ‡◊ão/’’J◊Eé=6÷ØåºØÒ≈E+£ú/[ù÷"0R£âösäò·Ó®÷“]€qmÃ4Ø‡zJ3¶p»≤cùÒ≤‹1|£‡!|\aU>ÇW∞qÂD∫zgbe”C∂›â±4\Ù⁄fBÉ≈¸Ò
ÕK^ß,äúQœç„¬®§8≠·‰°¥õ√eÃ)˛I˙òß„Ôa≈åÍsëÍıôD Ùw∞ìw˜ÅˆóåC«ç˚qËÄ¢ÚpíD96º)sM∆º¥d»Â ‰¸£v	Yl ≥mRlç'h,S¸ì õ„˚1ÿD	~M®@v¨§ìY∂>^Ω˝ƒ8Erq=µ“#gPzt¶Jï∆—@TÉ?X¡‚#Yø÷zˇ4˘ÅXB¥l®)Ñ>+Z¢j^q=%Y±O¨—äJFƒ†°ŒÃj˜È¥înøèââÉt`/ﬂ\î”OÜ¯Œ–xÿ‘î_L`Ö6Ÿb®h˘xú£iÖ∂uˆ MRÖ€ƒãd‰y}ûÆú(‰iLËÜ	¿ÖZ4c?Ω∏à÷ 2bcäSnÏ>WNE·gëÖ¥!|<πD#ño)Ñ…™î+˚%"Ö ÷∏™◊˙uGõÅ_@SóÍAÊ√}∆ƒﬂC?ÃÄﬂJüs,H,{å≤Z„ÄéZa5k¨MÊÑoMÀS¿Î<Íÿ>‰ggΩ´7âÖKU◊)^04∂kSfp¨èS˝©ß¬ΩÔIo¯7 rÖy§øòa)CUb@˝4ï4I* #)Œ5‚¨ q‡_ö yˆB]ˆX X†w«”a)Hö"œAµOWò#rÍ
„&3*≈©YˆugLäYÂ∏Äi¿÷:¢LzeJîYu¨6◊õ¡Ú¢y≈,ÌˆMÁº;8eŸ˙€ΩÛŒa©¡D¬…uÔ«Nı·ﬁT≥ùÂÊVÕw˙<¡ËVÕ≥Ã›¨Óo=ñﬁ≈Y‘æø2Ï€i;6Ëw>O5†&ÙπïG√DzT„z˜LΩÕﬂb`¥è… GÃ’–≈⁄°Sõ‡Q4ùH:xyµ†Ú*hπ∞`ÏS5_ƒ ÀôLòMüÂí@4¡JlR¡RPï)OL**Äì1+V ‹åb¡ÓôT	<⁄‘≈c,ËI
7ÁÊH√ˆÉEdïÂ|gl¨“ô)ÿQk…A	æ2¸0^}à_"•Œï◊£~_iÕâ«îz˜`¨WÛF∫ì9h˝Ø '£ÕÒbC€Ô#H+Ä,dÛ√yP´P˘öU7¨– ‹UaÊ¢»KÄçDÓÃôo"öLÑ™H≠TÃπ:^º©VÉò#\F	*–	^ºO$√*ûû≠}q⁄Ω$gßÁØ@˙¸û∞‘QJzÙª&·o±U¨‹aî.âsƒ‚ÿù˘ä'îQ§·å[≤õ¬õMÛödb∆Y≠p˜8Õ OõÃ#HrÒ(∞ˆq@@ƒÑ
 —$3.‰ç'ï°!cD,&´⁄˝}òÁ£B…9[L»ù;ÆäÏ˝êŸÌ"cç*Èòﬁ."¶¡>£ â]/ç.ñè∂,˝∞†Ma(ämÛ (b‚K„Œq1´π4lcBgh*˝… ^¶Çc‘öµ–è<jWx¸È' æ?D_≈˚>∞\ãÜ]aÑ¢¯[BüÂ]Cƒû°al”í´`1AÖ>5‹—î7i˛c¢Så¬93|g~6˝i‘ªÅuƒâÓ∆“0}≈õ∂	¡6Ÿ≤.ìÏf
2àE:‡ÿ∫©lˆXGC¶w¸¿ˇU ëD9èv˙–”m/†vG;◊u‹3|î#º√y¸”ü˛?   ˇˇ x≥v
                  ...
                  <div className="flex flex-col gap-2.5">
                    ...
                    >
                      <div className="flex items-center gap-2.5 text-cyan-400">
                        ...
                        <div className="flex flex-col text-left">
                          <span className="font-hud text-[9px] sm:text-[10px] font-bold uppercase tracking-widest whitespace-nowrap">Pokethology Tutorial</span>
                    ...
                    >
                      <div className="flex items-center gap-2.5">
                        ...
                        <div className="flex flex-col text-left">
                          <span className="font-hud text-[9px] sm:text-[10px] font-bold uppercase tracking-widest whitespace-nowrap">Pokethology Instagram</span>

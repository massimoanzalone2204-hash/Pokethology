...
import { DisclaimerModal, DisclaimerButton } from './DisclaimerModal';
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-4 sm:p-8">
              <div className="max-w-3xl mx-auto space-y-6">
                ...
                {/* Copyright & Disclaimer Toggle Section */}
                <div className="flex flex-col items-center justify-center pt-5 mt-2 border-t border-slate-800/80">

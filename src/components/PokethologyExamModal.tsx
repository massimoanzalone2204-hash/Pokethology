...
import { PokethologyQuizWidget } from './PokethologyQuizWidget';
import { sounds } from '../lib/sounds';
import { playHaptic } from '../lib/utils';

interface PokethologyExamModalProps {
  isOpen: boolean;
  onClose: () => void;
  today?: string;
}

export const PokethologyExamModal: React.FC<PokethologyExamModalProps> = ({
  isOpen,
  onClose,

...
export const Tutorial = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
  ...
  const [pokemonNews, setPokemonNews] = useState<any[]>(DEFAULT_NEWS);
    ...
    if (isOpen && activeTab === 'news') {
      ...
      const fetchNews = async () => {
        ...
        try {
          ...
          if (isMounted) {
            setPokemonNews(data.news && data.news.length > 0 ? data.news : DEFAULT_NEWS);
            setIsFallback(data.isFallback ?? false);
          }
        } catch (err: any) {
          if (isMounted) {
            setPokemonNews(DEFAULT_NEWS);
            setIsFallback(true);
          }
        } finally {
          if (isMounted) {
      ...
      >
        ...
        <div className="shrink-0 flex justify-between items-center px-4 sm:px-8 py-3.5 border-b border-cyan-500/30 w-full bg-slate-900/90 z-20 shadow-lg">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-cyan-950/80 border border-cyan-500/50 rounded-xl text-cyan-300 shadow-[0_0_15px_rgba(34,211,238,0.3)] shrink-0">
          ...
          {activeTab === 'pokedex' && (
            ...
            >
              ...
              <div className="grid grid-cols-1 gap-3 text-left">
                ...
                <div className="p-4 rounded-xl border border-emerald-500/30 bg-slate-900/60 flex items-start gap-4 group hover:border-emerald-400 transition-all shadow-md">
                ...
                {/* Historical Archives & Ball Rank */}
                <div className="p-4 rounded-xl border border-amber-500/30 bg-slate-900/60 flex items-start gap-4 group hover:border-amber-400 transition-all shadow-md">
                  <div className="p-3 bg-amber-950 rounded-full border border-amber-500/50 shrink-0 group-hover:scale-110 transition-transform">
                  ...
                  <div className="flex flex-col text-left min-w-0 flex-1 space-y-1">
                    ...
                    <p className="text-[10.5px] sm:text-[11px] text-slate-300 leading-relaxed font-sans mt-0.5">
                      Click the glowing Poké Ball rank badge (Poké, Great, Ultra, or Master Ball) in the top header or home interface to launch the Historical Season Archive modal. Inspect your monthly season progress, past cleared seasons, overall Operator Rank score breakdowns, and the dedicated Hub & Exam lifetime completion statistics tab.
                    </p>
                  </div>
                </div>

                {/* Artwork & Sprite Presentation Modes */}
                <div className="p-4 rounded-xl border border-cyan-500/30 bg-slate-900/60 flex items-start gap-4 group hover:border-cyan-400 transition-all shadow-md">
                ...
                <div className="p-4 rounded-xl border border-yellow-500/30 bg-slate-900/60 flex items-start gap-4 group hover:border-yellow-400 transition-all shadow-md">
            ...
            >
              ...
              <div className="p-4 bg-purple-950/25 border-l-4 border-purple-500 rounded-r-xl space-y-2 text-left relative overflow-hidden">
                <h3 className="font-hud font-black text-purple-400 uppercase text-xs sm:text-sm tracking-wider flex items-center gap-2">
                  <Brain className="w-4 h-4 text-purple-400 animate-pulse" /> AI Assistant
                </h3>
                <p className="text-slate-300 font-sans leading-relaxed text-[11px] sm:text-xs relative z-10">
              ...
              <div className="grid grid-cols-1 gap-3 text-left">
                ...
                <div className="p-4 rounded-xl border border-purple-500/30 bg-slate-900/60 flex items-start gap-4 group hover:border-purple-400 transition-all shadow-md">
            ...
            >
              ...
              <div className="p-4 bg-red-950/25 border-l-4 border-red-500 rounded-r-xl space-y-2 text-left relative overflow-hidden">
                <h3 className="font-hud font-black text-red-400 uppercase text-xs sm:text-sm tracking-wider flex items-center gap-2">
                  <Swords className="w-4 h-4 text-red-500 animate-pulse" /> Combat Arena
                </h3>
                <p className="text-slate-300 font-sans leading-relaxed text-[11px] sm:text-xs relative z-10">
              ...
              <div className="grid grid-cols-1 gap-3 text-left">
                ...
                <div className="p-4 rounded-xl border border-red-500/30 bg-slate-900/60 flex items-start gap-4 group hover:border-red-400 transition-all shadow-md">
            ...
            >
              ...
              <div className="p-4 bg-amber-950/25 border-l-4 border-amber-500 rounded-r-xl space-y-2 text-left relative overflow-hidden">
                <h3 className="font-hud font-black text-amber-400 uppercase text-xs sm:text-sm tracking-wider flex items-center gap-2">
                  <Calendar className="w-4 h-4 text-amber-400 animate-bounce" /> Daily Hub
                </h3>
                <p className="text-slate-300 font-sans leading-relaxed text-[11px] sm:text-xs relative z-10">
              ...
              <div className="grid grid-cols-1 gap-3.5 text-left">
                ...
                <div className="p-4 rounded-xl border border-amber-500/30 bg-slate-900/60 flex items-start gap-4 group hover:border-amber-400 transition-all shadow-md">
                  <div className="p-3 bg-amber-950 rounded-full border border-amber-500/50 group-hover:scale-110 transition-transform shrink-0">
                    <Target className="w-5 h-5 text-amber-400" />
                  </div>
                  <div className="flex flex-col text-left min-w-0 flex-1 space-y-1.5">
                    <span className="font-hud font-black text-amber-300 text-xs sm:text-sm uppercase tracking-wider block">
                      Missions & Rank
                    </span>
                    <p className="text-[10.5px] sm:text-[11px] text-slate-300 leading-relaxed font-sans mt-0.5">
                      The core competitive objective is to conquer the arena with every single Pokémon species, Mega Evolution, Gigantamax variant, and Alternate Form across the 1226 units in the Pokédex while mastering all 18 elemental types. You can access and review your progress anytime inside the <span className="text-cyan-300 font-bold font-hud uppercase">Combat Options</span> menu or by clicking the top Rank Ball.
                    </p>
                    
                    {/* Rank Calculation Pillars */}
                    <div className="bg-slate-950/60 p-3 rounded-lg border border-amber-500/20 space-y-1.5 my-1">
            ...
            >
              ...
              <div className="p-4 bg-pink-950/25 border-l-4 border-pink-500 rounded-r-xl space-y-2 text-left relative overflow-hidden">
                <h3 className="font-hud font-black text-pink-400 uppercase text-xs sm:text-sm tracking-wider flex items-center gap-2">
                  <Share2 className="w-4 h-4 text-pink-400 animate-pulse" /> Community & Repositories
                </h3>
                <p className="text-slate-300 font-sans leading-relaxed text-[11px] sm:text-xs relative z-10">
                ...
                >
                  <div className="flex items-center gap-4 min-w-0">
                    ...
                    <div className="flex flex-col text-left min-w-0">
                      ...
                      <span className="text-[9.5px] text-slate-400 font-sans mt-0.5">Explore Pokémon discussions, the latest franchise news, new updates, and fascinating curiosities about the brand.</span>
                    </div>
                  </div>
              ...
              <div className="p-4 bg-cyan-950/25 border-l-4 border-cyan-500 rounded-r-xl space-y-2 text-left relative overflow-hidden">
                <div className="flex items-center justify-between border-b border-cyan-500/25 pb-2">
                  <h3 className="font-hud font-black text-cyan-400 uppercase text-xs sm:text-sm tracking-wider flex items-center gap-2">
                    <Globe className="w-4 h-4 text-cyan-400 animate-spin-slow" /> Global News
                  </h3>
                  {isFallback && (
